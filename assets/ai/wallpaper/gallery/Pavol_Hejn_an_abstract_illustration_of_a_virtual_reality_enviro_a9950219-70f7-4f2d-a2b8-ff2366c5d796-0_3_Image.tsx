...
AnAbstractIllustrationOfAVirtualRealityEnviroA995021970f74f2dA2b8Ff2366c5d7960_3_Image.colorStats = {
    ...
    lightestColor: Color.fromHex('#ffeff8'),
    darkestColor: Color.fromHex('#210101'),
    minmaxWhite: [Color.fromHex('#ffeff8'), Color.fromHex('#18000a')],
    minmaxRed: [Color.fromHex('#ee0800'), Color.fromHex('#1ee9ff')],
    minmaxGreen: [Color.fromHex('#1ca89d'), Color.fromHex('#ee0800')],
    minmaxBlue: [Color.fromHex('#093587'), Color.fromHex('#fff7d2')],
    mostFrequentColor: Color.fromHex('#180625'),
    mostSaturatedColor: Color.fromHex('#2f001c'),
    mostGroupedColor: Color.fromHex('#230821'),
    bottom: {
        averageColor: Color.fromHex('#9f3243'),
        lightestColor: Color.fromHex('#ffeff8'),
        darkestColor: Color.fromHex('#340000'),
        minmaxWhite: [Color.fromHex('#ffeff8'), Color.fromHex('#20000e')],
        minmaxRed: [Color.fromHex('#fd150b'), Color.fromHex('#47d1ff')],
        minmaxGreen: [Color.fromHex('#07747f'), Color.fromHex('#fd150b')],
        minmaxBlue: [Color.fromHex('#093587'), Color.fromHex('#fff7d2')],
        mostFrequentColor: Color.fromHex('#180625'),
        mostSaturatedColor: Color.fromHex('#290021'),
        mostGroupedColor: Color.fromHex('#230821'),
    },
