...
AWallpaperFeaturingAnAbstractIllustrationOfA6dd7a2603935489cB5b5305f0b44a0230_1_Image.colorStats = {
    averageColor: Color.fromHex('#1a1926'),
    ...
    bottom: {
        averageColor: Color.fromHex('#2a1d27'),
        lightestColor: Color.fromHex('#ffeeee'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffee'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#dd3322'), Color.fromHex('#ffffee')],
        minmaxGreen: [Color.fromHex('#887755'), Color.fromHex('#ee3344')],
        minmaxBlue: [Color.fromHex('#112255'), Color.fromHex('#ffffee')],
        mostFrequentColor: Color.fromHex('#000011'),
        mostSaturatedColor: Color.fromHex('#000011'),
        mostGroupedColor: Color.fromHex('#000011'),
    },
