...
AnImageOfARocketLaunchingIntoSpaceWithATraD410ad0b1da14afbBf816e1beffb85a10_0_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#448899'), Color.fromHex('#ffffff')],
    ...
    bottom: {
        ...
        minmaxGreen: [Color.fromHex('#997777'), Color.fromHex('#ffffff')],
        minmaxBlue: [Color.fromHex('#222244'), Color.fromHex('#ffffdd')],
        mostFrequentColor: Color.fromHex('#001122'),
        mostSaturatedColor: Color.fromHex('#000011'),
