...
AnAbstractImageOfANebulaWithBrightColorsAndAc627f559554415eAc985ca8fb4a06310_0_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#559977'), Color.fromHex('#bb2233')],
    minmaxBlue: [Color.fromHex('#113366'), Color.fromHex('#ffbb22')],
    mostFrequentColor: Color.fromHex('#222211'),
    mostSaturatedColor: Color.fromHex('#001122'),
    mostGroupedColor: Color.fromHex('#111111'),
    bottom: {
        averageColor: Color.fromHex('#45362d'),
        lightestColor: Color.fromHex('#eedddd'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eedddd'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#cc3322'), Color.fromHex('#dddddd')],
        minmaxGreen: [Color.fromHex('#778866'), Color.fromHex('#bb2233')],
