...
AWallpaperFeaturingAnAbstractIllustrationOfAn3776e2686f514049Ba720277e62ebba50_2_Image.colorStats = {
    ...
    minmaxWhite: [Color.fromHex('#ddaadd'), Color.fromHex('#000022')],
    minmaxRed: [Color.fromHex('#ee3333'), Color.fromHex('#00ffee')],
    minmaxGreen: [Color.fromHex('#22cc77'), Color.fromHex('#ee11ff')],
    minmaxBlue: [Color.fromHex('#1100cc'), Color.fromHex('#ff9966')],
    ...
    bottom: {
        ...
        lightestColor: Color.fromHex('#99bbff'),
        darkestColor: Color.fromHex('#000011'),
        minmaxWhite: [Color.fromHex('#99bbff'), Color.fromHex('#000011')],
        minmaxRed: [Color.fromHex('#bb3355'), Color.fromHex('#00ffaa')],
        minmaxGreen: [Color.fromHex('#11cc77'), Color.fromHex('#dd44dd')],
        minmaxBlue: [Color.fromHex('#1122dd'), Color.fromHex('#11ffaa')],
        mostFrequentColor: Color.fromHex('#333377'),
        mostSaturatedColor: Color.fromHex('#004477'),
        mostGroupedColor: Color.fromHex('#113355'),
    },
