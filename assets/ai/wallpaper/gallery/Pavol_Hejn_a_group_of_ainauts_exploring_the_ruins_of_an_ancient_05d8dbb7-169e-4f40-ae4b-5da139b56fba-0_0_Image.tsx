...
AGroupOfAinautsExploringTheRuinsOfAnAncient5d8dbb7169e4f40Ae4b5da139b56fba00_0_Image.colorStats = {
    averageColor: Color.fromHex('#8e8478'),
    ...
    minmaxBlue: [Color.fromHex('#223355'), Color.fromHex('#ffdd88')],
    mostFrequentColor: Color.fromHex('#222222'),
    mostSaturatedColor: Color.fromHex('#884411'),
    mostGroupedColor: Color.fromHex('#555555'),
    bottom: {
        averageColor: Color.fromHex('#745d4b'),
        lightestColor: Color.fromHex('#ffcc99'),
        darkestColor: Color.fromHex('#442200'),
        minmaxWhite: [Color.fromHex('#ffcc99'), Color.fromHex('#111111')],
        minmaxRed: [Color.fromHex('#aa5522'), Color.fromHex('#ffdd88')],
        minmaxGreen: [Color.fromHex('#998844'), Color.fromHex('#221122')],
        minmaxBlue: [Color.fromHex('#223355'), Color.fromHex('#ffdd88')],
        mostFrequentColor: Color.fromHex('#222222'),
