...
ADigitalPaintingOfADeepSeaCreatureWithTentaF9accf1c18a8458c88c9271d91a179530_3_Image.colorStats = {
    averageColor: Color.fromHex('#13272b'),
    lightestColor: Color.fromHex('#eeeeee'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#eeffee'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#994444'), Color.fromHex('#aaffee')],
    minmaxGreen: [Color.fromHex('#44aa88'), Color.fromHex('#ffffdd')],
