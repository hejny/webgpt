...
APhotographOfALavaFlowOnAVolcanicPlanetWit501ae47cE9874f3d9f11199be5534df80_2_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#ee2200'), Color.fromHex('#ffdd88')],
    minmaxGreen: [Color.fromHex('#888866'), Color.fromHex('#ee2200')],
    minmaxBlue: [Color.fromHex('#444455'), Color.fromHex('#ffcc22')],
    mostFrequentColor: Color.fromHex('#111111'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#111111'),
    bottom: {
        averageColor: Color.fromHex('#1f0e12'),
        lightestColor: Color.fromHex('#bb4455'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ff9922'), Color.fromHex('#000000')],
