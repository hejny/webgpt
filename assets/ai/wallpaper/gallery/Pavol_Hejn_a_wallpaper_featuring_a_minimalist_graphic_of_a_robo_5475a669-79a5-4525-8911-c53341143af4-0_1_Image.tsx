...
AWallpaperFeaturingAMinimalistGraphicOfARobo5475a66979a545258911C53341143af40_1_Image.colorStats = {
    ...
    minmaxBlue: [Color.fromHex('#226677'), Color.fromHex('#ffdd44')],
    ...
    bottom: {
        ...
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#665500'), Color.fromHex('#eeffff')],
        minmaxGreen: [Color.fromHex('#337777'), Color.fromHex('#ffeeff')],
