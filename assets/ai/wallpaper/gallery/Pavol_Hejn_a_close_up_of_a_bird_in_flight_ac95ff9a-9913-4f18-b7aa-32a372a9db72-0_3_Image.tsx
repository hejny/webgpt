...
import content from './Pavol_Hejn_a_close_up_of_a_bird_in_flight_ac95ff9a-9913-4f18-b7aa-32a372a9db72-0_3.content.md';
...
export function ACloseUpOfABirdInFlightAc95ff9a99134f18B7aa32a372a9db720_3_Image(props: IWallpaperComponentProps) {
    ...
    return (
        <Image
            ...
            src="https://cdn.midjourney.com/ac95ff9a-9913-4f18-b7aa-32a372a9db72/0_3.png"
            draggable="false"
            placeholder="blur"
...
ACloseUpOfABirdInFlightAc95ff9a99134f18B7aa32a372a9db720_3_Image.src = new URL(
    'https://cdn.midjourney.com/ac95ff9a-9913-4f18-b7aa-32a372a9db72/0_3.png',
);
...
ACloseUpOfABirdInFlightAc95ff9a99134f18B7aa32a372a9db720_3_Image.content = content;
