...
BlueWhaleAsIconForTheMobileAppCe1e0f4dA55f4772B7c9E07313cb41430_2_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#444466'), Color.fromHex('#22ffee')],
    minmaxGreen: [Color.fromHex('#118888'), Color.fromHex('#ffeeff')],
    ...
    bottom: {
        averageColor: Color.fromHex('#bbc8d9'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000022'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000022')],
        minmaxRed: [Color.fromHex('#444466'), Color.fromHex('#ddffff')],
