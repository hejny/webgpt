...
AWallpaperFeaturingAnAbstractIllustrationOfAD27e0ff082d54e938546170034318d620_2_Image.colorStats = {
    averageColor: Color.fromHex('#2f5e62'),
    lightestColor: Color.fromHex('#ffeeee'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#eeffee'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#ee6666'), Color.fromHex('#66eecc')],
    minmaxGreen: [Color.fromHex('#33aa77'), Color.fromHex('#ffeeee')],
    ...
    bottom: {
        averageColor: Color.fromHex('#275a61'),
        lightestColor: Color.fromHex('#ddeeee'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ddeeee'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#cc8877'), Color.fromHex('#aaeeee')],
        minmaxGreen: [Color.fromHex('#11aa88'), Color.fromHex('#ddeeee')],
        minmaxBlue: [Color.fromHex('#116677'), Color.fromHex('#ddeeee')],
        mostFrequentColor: Color.fromHex('#113333'),
