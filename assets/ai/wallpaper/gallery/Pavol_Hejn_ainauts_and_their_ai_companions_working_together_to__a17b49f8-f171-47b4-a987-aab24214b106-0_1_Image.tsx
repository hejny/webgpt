...
AinautsAndTheirAiCompanionsWorkingTogetherToA17b49f8F17147b4A987Aab24214b1060_1_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#995555'), Color.fromHex('#ffffff')],
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#995555'), Color.fromHex('#eeeeff')],
        minmaxGreen: [Color.fromHex('#777755'), Color.fromHex('#eeeeff')],
        minmaxBlue: [Color.fromHex('#446688'), Color.fromHex('#eeeedd')],
        mostFrequentColor: Color.fromHex('#111111'),
