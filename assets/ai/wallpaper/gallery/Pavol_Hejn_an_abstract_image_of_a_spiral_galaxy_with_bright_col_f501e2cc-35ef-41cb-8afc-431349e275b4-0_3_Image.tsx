...
AnAbstractImageOfASpiralGalaxyWithBrightColF501e2cc35ef41cb8afc431349e275b40_3_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#cc2200'), Color.fromHex('#ddeeee')],
    minmaxGreen: [Color.fromHex('#779944'), Color.fromHex('#990000')],
    minmaxBlue: [Color.fromHex('#114488'), Color.fromHex('#ffcc11')],
    mostFrequentColor: Color.fromHex('#552211'),
    mostSaturatedColor: Color.fromHex('#001133'),
    mostGroupedColor: Color.fromHex('#000011'),
    bottom: {
        averageColor: Color.fromHex('#654d3a'),
        lightestColor: Color.fromHex('#ffeeee'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffeeee'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#cc2200'), Color.fromHex('#ffeeee')],
        minmaxGreen: [Color.fromHex('#779933'), Color.fromHex('#bb1100')],
