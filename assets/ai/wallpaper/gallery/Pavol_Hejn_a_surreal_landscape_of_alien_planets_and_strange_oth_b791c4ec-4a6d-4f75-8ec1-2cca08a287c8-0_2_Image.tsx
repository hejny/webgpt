...
ASurrealLandscapeOfAlienPlanetsAndStrangeOthB791c4ec4a6d4f758ec12cca08a287c80_2_Image.colorStats = {
    averageColor: Color.fromHex('#5a605e'),
    ...
    bottom: {
        averageColor: Color.fromHex('#39322f'),
        lightestColor: Color.fromHex('#ccdddd'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffeebb'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#aa5544'), Color.fromHex('#ccdddd')],
        minmaxGreen: [Color.fromHex('#778866'), Color.fromHex('#110022')],
