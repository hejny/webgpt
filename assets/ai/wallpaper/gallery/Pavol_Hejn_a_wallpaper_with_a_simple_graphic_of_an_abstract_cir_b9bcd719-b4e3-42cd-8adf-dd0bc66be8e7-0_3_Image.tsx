...
export function AWallpaperWithASimpleGraphicOfAnAbstractCirB9bcd719B4e342cd8adfDd0bc66be8e70_3_Image() {
    return (
        <Image
            ...
            src={a_wallpaper_with_a_simple_graphic_of_an_abstract_cir_b9bcd719_b4e3_42cd_8adf_dd0bc66be8e7_0_3}
            draggable="false"
            placeholder="blur"
...
AWallpaperWithASimpleGraphicOfAnAbstractCirB9bcd719B4e342cd8adfDd0bc66be8e70_3_Image.colorStats = {
    ...
    lightestColor: Color.fromHex('#58e6e9'),
    darkestColor: Color.fromHex('#000000'),
    mostFrequentColor: Color.fromHex('#091d20'),
    leastFrequentColor: Color.fromHex('#1e444b'),
