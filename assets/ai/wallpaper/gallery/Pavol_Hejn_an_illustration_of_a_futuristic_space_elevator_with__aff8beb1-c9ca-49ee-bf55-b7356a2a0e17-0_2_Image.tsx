...
import source from './Pavol_Hejn_an_illustration_of_a_futuristic_space_elevator_with__aff8beb1-c9ca-49ee-bf55-b7356a2a0e17-0_2.png';
...
AnIllustrationOfAFuturisticSpaceElevatorWithAff8beb1C9ca49eeBf55B7356a2a0e170_2_Image.colorStats = {
    averageColor: Color.fromHex('#273c50'),
    ...
    bottom: {
        averageColor: Color.fromHex('#151e2c'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#996633'), Color.fromHex('#ddffff')],
        minmaxGreen: [Color.fromHex('#999955'), Color.fromHex('#ffffff')],
        minmaxBlue: [Color.fromHex('#224477'), Color.fromHex('#ffff88')],
        mostFrequentColor: Color.fromHex('#111122'),
        mostSaturatedColor: Color.fromHex('#002233'),
        mostGroupedColor: Color.fromHex('#000011'),
    },
