...
APhotographOfAMountainRangeOnAnotherPlanetW888a4d10C1bb40dc8bb0234ffb78f2530_2_Image.colorStats = {
    ...
    mostFrequentColor: Color.fromHex('#551100'),
    mostSaturatedColor: Color.fromHex('#110000'),
    mostGroupedColor: Color.fromHex('#ffffee'),
    bottom: {
        averageColor: Color.fromHex('#522c20'),
        lightestColor: Color.fromHex('#eeccaa'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eeccaa'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#aa4411'), Color.fromHex('#eeccaa')],
        minmaxGreen: [Color.fromHex('#886633'), Color.fromHex('#440000')],
        minmaxBlue: [Color.fromHex('#443344'), Color.fromHex('#eeccaa')],
        mostFrequentColor: Color.fromHex('#551100'),
