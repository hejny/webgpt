...
ADigitalPaintingOfALoneAstronautStandingOnT52813773864c445fA336F22707e901360_1_Image.colorStats = {
    averageColor: Color.fromHex('#7e6962'),
    ...
    bottom: {
        averageColor: Color.fromHex('#543b37'),
        lightestColor: Color.fromHex('#ccbbbb'),
        darkestColor: Color.fromHex('#111111'),
        minmaxWhite: [Color.fromHex('#eeccaa'), Color.fromHex('#110011')],
        minmaxRed: [Color.fromHex('#994422'), Color.fromHex('#eeccaa')],
        minmaxGreen: [Color.fromHex('#446677'), Color.fromHex('#110011')],
        minmaxBlue: [Color.fromHex('#335566'), Color.fromHex('#eeccaa')],
        mostFrequentColor: Color.fromHex('#332222'),
        mostSaturatedColor: Color.fromHex('#110011'),
