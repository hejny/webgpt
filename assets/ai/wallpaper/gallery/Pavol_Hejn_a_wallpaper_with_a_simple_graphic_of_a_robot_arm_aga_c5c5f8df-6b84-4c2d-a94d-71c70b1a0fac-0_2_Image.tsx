...
AWallpaperWithASimpleGraphicOfARobotArmAgaC5c5f8df6b844c2dA94d71c70b1a0fac0_2_Image.colorStats = {
    averageColor: Color.fromHex('#958b5d'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#001100'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#dd2233'), Color.fromHex('#ffffff')],
    minmaxGreen: [Color.fromHex('#33bb55'), Color.fromHex('#ff3333')],
    minmaxBlue: [Color.fromHex('#444455'), Color.fromHex('#ffffee')],
    mostFrequentColor: Color.fromHex('#551133'),
    mostSaturatedColor: Color.fromHex('#009966'),
    mostGroupedColor: Color.fromHex('#111111'),
    bottom: {
        averageColor: Color.fromHex('#756e58'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#001100'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#ee3333'), Color.fromHex('#ffffff')],
        minmaxGreen: [Color.fromHex('#22bb77'), Color.fromHex('#ffffff')],
        minmaxBlue: [Color.fromHex('#116666'), Color.fromHex('#ffffff')],
        mostFrequentColor: Color.fromHex('#551133'),
        mostSaturatedColor: Color.fromHex('#009966'),
