...
import content from './Pavol_Hejn_a_wallpaper_featuring_a_colorful_fractal_pattern_wit_2de6a8c8-4984-40df-bd0b-abe3922930c1-0_2.content.md';
...
export function AWallpaperFeaturingAColorfulFractalPatternWitde6a8c8498440dfBd0bAbe3922930c102_2_Image(
    ...
    return (
        <Image
            ...
            src="https://cdn.midjourney.com/2de6a8c8-4984-40df-bd0b-abe3922930c1/0_2.png"
            draggable="false"
            placeholder="blur"
...
AWallpaperFeaturingAColorfulFractalPatternWitde6a8c8498440dfBd0bAbe3922930c102_2_Image.src = new URL(
    'https://cdn.midjourney.com/2de6a8c8-4984-40df-bd0b-abe3922930c1/0_2.png',
);
...
AWallpaperFeaturingAColorfulFractalPatternWitde6a8c8498440dfBd0bAbe3922930c102_2_Image.content = content;
