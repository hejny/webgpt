...
APhotographOfADesertLandscapeAtNightWithThe93e80a95D8f545569324B10f8d61dee50_2_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#774422'), Color.fromHex('#bbffff')],
    ...
    bottom: {
        ...
        lightestColor: Color.fromHex('#885533'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#885533'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#774422'), Color.fromHex('#001111')],
        minmaxGreen: [Color.fromHex('#775533'), Color.fromHex('#110011')],
        minmaxBlue: [Color.fromHex('#443333'), Color.fromHex('#000000')],
        mostFrequentColor: Color.fromHex('#000011'),
