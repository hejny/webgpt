...
ADigitalImageOfABlackHoleWithTheDistortedSC6ec64aaC04349098d9aBd9b4f7f0e4b0_0_Image.colorStats = {
    ...
    lightestColor: Color.fromHex('#bb88dd'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffdd99'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#bb3311'), Color.fromHex('#55eeee')],
    minmaxGreen: [Color.fromHex('#55aa88'), Color.fromHex('#cc11aa')],
    minmaxBlue: [Color.fromHex('#4444bb'), Color.fromHex('#ffdd77')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#110011'),
    mostGroupedColor: Color.fromHex('#000000'),
    bottom: {
        averageColor: Color.fromHex('#292230'),
        lightestColor: Color.fromHex('#66bbee'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffdd99'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#cc3311'), Color.fromHex('#55eeee')],
        minmaxGreen: [Color.fromHex('#aa8833'), Color.fromHex('#aa11bb')],
        minmaxBlue: [Color.fromHex('#2255aa'), Color.fromHex('#ffdd77')],
        mostFrequentColor: Color.fromHex('#000000'),
