...
import source from './Pavol_Hejn_a_black_and_white_outline_of_a_satellite_with_intric_9e12bef5-0be8-45cd-8779-eea3a27bf1f9-0_3.png';
...
ABlackAndWhiteOutlineOfASatelliteWithIntric9e12bef50be845cd8779Eea3a27bf1f90_3_Image.colorStats = {
    averageColor: Color.fromHex('#d5d5d4'),
    ...
    bottom: {
        averageColor: Color.fromHex('#e7e7e7'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#554444'), Color.fromHex('#eeffff')],
