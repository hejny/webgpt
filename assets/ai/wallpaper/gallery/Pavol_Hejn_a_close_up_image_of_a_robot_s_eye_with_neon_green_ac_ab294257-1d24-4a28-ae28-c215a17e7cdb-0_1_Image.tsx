...
ACloseUpImageOfARobotSEyeWithNeonGreenAcAb2942571d244a28Ae28C215a17e7cdb0_1_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#aa5544'), Color.fromHex('#11eeee')],
    minmaxGreen: [Color.fromHex('#00cc55'), Color.fromHex('#eeeeff')],
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#331111'), Color.fromHex('#11ccdd')],
        minmaxGreen: [Color.fromHex('#00cc55'), Color.fromHex('#ddffee')],
        minmaxBlue: [Color.fromHex('#116677'), Color.fromHex('#ddffee')],
        mostFrequentColor: Color.fromHex('#000000'),
