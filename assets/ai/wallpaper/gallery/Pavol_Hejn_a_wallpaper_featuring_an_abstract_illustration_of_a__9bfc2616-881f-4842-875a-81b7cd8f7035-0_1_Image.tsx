...
AWallpaperFeaturingAnAbstractIllustrationOfA9bfc2616881f4842875a81b7cd8f70350_1_Image.colorStats = {
    averageColor: Color.fromHex('#292956'),
    lightestColor: Color.fromHex('#ffeeff'),
    darkestColor: Color.fromHex('#001122'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000022')],
    minmaxRed: [Color.fromHex('#bb3366'), Color.fromHex('#99ffdd')],
    minmaxGreen: [Color.fromHex('#44bb99'), Color.fromHex('#ee44cc')],
    minmaxBlue: [Color.fromHex('#3344aa'), Color.fromHex('#ffffbb')],
    mostFrequentColor: Color.fromHex('#001133'),
    mostSaturatedColor: Color.fromHex('#001133'),
    mostGroupedColor: Color.fromHex('#001133'),
    bottom: {
        averageColor: Color.fromHex('#422f5f'),
        lightestColor: Color.fromHex('#ffddff'),
        darkestColor: Color.fromHex('#001122'),
        minmaxWhite: [Color.fromHex('#ffffee'), Color.fromHex('#000033')],
        minmaxRed: [Color.fromHex('#cc3377'), Color.fromHex('#ffffee')],
        minmaxGreen: [Color.fromHex('#33bb99'), Color.fromHex('#ff77ee')],
        minmaxBlue: [Color.fromHex('#5533aa'), Color.fromHex('#ffffbb')],
        mostFrequentColor: Color.fromHex('#001133'),
        mostSaturatedColor: Color.fromHex('#001133'),
        mostGroupedColor: Color.fromHex('#001133'),
    },
