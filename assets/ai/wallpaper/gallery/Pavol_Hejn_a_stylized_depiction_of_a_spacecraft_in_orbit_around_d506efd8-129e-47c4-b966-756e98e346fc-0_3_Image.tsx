...
import source from './Pavol_Hejn_a_stylized_depiction_of_a_spacecraft_in_orbit_around_d506efd8-129e-47c4-b966-756e98e346fc-0_3.png';
...
AStylizedDepictionOfASpacecraftInOrbitAroundD506efd8129e47c4B966756e98e346fc0_3_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#75361b'), Color.fromHex('#f6ffff')],
    minmaxGreen: [Color.fromHex('#637d6f'), Color.fromHex('#fffeff')],
    minmaxBlue: [Color.fromHex('#3a4455'), Color.fromHex('#ffffe3')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#000001'),
    mostGroupedColor: Color.fromHex('#000000'),
    bottom: {
        averageColor: Color.fromHex('#1a130f'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#75361b'), Color.fromHex('#ffffff')],
        minmaxGreen: [Color.fromHex('#a29665'), Color.fromHex('#ffffff')],
        minmaxBlue: [Color.fromHex('#3a4455'), Color.fromHex('#ffffe7')],
        mostFrequentColor: Color.fromHex('#000000'),
        mostSaturatedColor: Color.fromHex('#000001'),
        mostGroupedColor: Color.fromHex('#000000'),
    },
