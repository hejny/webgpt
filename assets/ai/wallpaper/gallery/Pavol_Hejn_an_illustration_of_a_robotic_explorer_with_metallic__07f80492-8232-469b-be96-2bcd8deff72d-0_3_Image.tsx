...
AnIllustrationOfARoboticExplorerWithMetallic07f804928232469bBe962bcd8deff72d0_3_Image.colorStats = {
    averageColor: Color.fromHex('#3e544b'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#aa6622'), Color.fromHex('#ddffff')],
    ...
    bottom: {
        averageColor: Color.fromHex('#303b36'),
        lightestColor: Color.fromHex('#cceeee'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#cceeee'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#774411'), Color.fromHex('#99eedd')],
        minmaxGreen: [Color.fromHex('#117766'), Color.fromHex('#220000')],
        minmaxBlue: [Color.fromHex('#224455'), Color.fromHex('#cceeee')],
        mostFrequentColor: Color.fromHex('#224444'),
        mostSaturatedColor: Color.fromHex('#001111'),
        mostGroupedColor: Color.fromHex('#224444'),
    },
