...
APhotographOfAnIcebergInTheArcticWithTheBlD217abd00b234a829096D9791a52ffe90_0_Image.colorStats = {
    averageColor: Color.fromHex('#1b3848'),
    lightestColor: Color.fromHex('#6699aa'),
    darkestColor: Color.fromHex('#001111'),
    minmaxWhite: [Color.fromHex('#6699aa'), Color.fromHex('#001111')],
    minmaxRed: [Color.fromHex('#334455'), Color.fromHex('#007799')],
    minmaxGreen: [Color.fromHex('#117788'), Color.fromHex('#111122')],
    ...
    bottom: {
        averageColor: Color.fromHex('#142b38'),
        lightestColor: Color.fromHex('#7799aa'),
        darkestColor: Color.fromHex('#001111'),
        minmaxWhite: [Color.fromHex('#7799aa'), Color.fromHex('#001111')],
        minmaxRed: [Color.fromHex('#334455'), Color.fromHex('#6699aa')],
        minmaxGreen: [Color.fromHex('#337788'), Color.fromHex('#111122')],
