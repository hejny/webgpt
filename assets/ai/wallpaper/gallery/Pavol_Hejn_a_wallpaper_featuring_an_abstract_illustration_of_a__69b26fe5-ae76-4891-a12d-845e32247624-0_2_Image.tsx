...
AWallpaperFeaturingAnAbstractIllustrationOfA69b26fe5Ae764891A12d845e322476240_2_Image.colorStats = {
    averageColor: Color.fromHex('#180609'),
    lightestColor: Color.fromHex('#ccbbcc'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ccbbcc'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#ee2211'), Color.fromHex('#ccbbcc')],
    minmaxGreen: [Color.fromHex('#777777'), Color.fromHex('#ee2211')],
    minmaxBlue: [Color.fromHex('#554466'), Color.fromHex('#ffcc88')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#110000'),
    mostGroupedColor: Color.fromHex('#000000'),
    bottom: {
        averageColor: Color.fromHex('#120305'),
        lightestColor: Color.fromHex('#ff8855'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ff8855'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#ee2211'), Color.fromHex('#000011')],
        minmaxGreen: [Color.fromHex('#443333'), Color.fromHex('#ee2211')],
        minmaxBlue: [Color.fromHex('#443333'), Color.fromHex('#ff7733')],
        mostFrequentColor: Color.fromHex('#000000'),
