...
AWallpaperFeaturingARepeatingPatternOfSleekA9115007494a94b45A508A7f8776699e70_0_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#dd3355'), Color.fromHex('#eeffff')],
    minmaxGreen: [Color.fromHex('#337766'), Color.fromHex('#ff44dd')],
    minmaxBlue: [Color.fromHex('#444488'), Color.fromHex('#ffffff')],
    mostFrequentColor: Color.fromHex('#ee4466'),
    mostSaturatedColor: Color.fromHex('#110022'),
    mostGroupedColor: Color.fromHex('#333344'),
    bottom: {
        averageColor: Color.fromHex('#655869'),
        lightestColor: Color.fromHex('#ffbbff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#ee4455'), Color.fromHex('#eeffff')],
        minmaxGreen: [Color.fromHex('#668877'), Color.fromHex('#ffbbff')],
        minmaxBlue: [Color.fromHex('#662277'), Color.fromHex('#ffffff')],
        mostFrequentColor: Color.fromHex('#ee4466'),
