...
import source from './Pavol_Hejn_a_black_and_white_outline_of_a_satellite_with_intric_9e12bef5-0be8-45cd-8779-eea3a27bf1f9-0_2.png';
...
ABlackAndWhiteOutlineOfASatelliteWithIntric9e12bef50be845cd8779Eea3a27bf1f90_2_Image.colorStats = {
    ...
    bottom: {
        averageColor: Color.fromHex('#c2c2c1'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#554444'), Color.fromHex('#eeffff')],
