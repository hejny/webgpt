...
SunriseOnADistantPlanetD5bb2707A5e04e4f96b155d4003057d70_2_Image.colorStats = {
    averageColor: Color.fromHex('#87615a'),
    lightestColor: Color.fromHex('#ffffdd'),
    darkestColor: Color.fromHex('#000011'),
    minmaxWhite: [Color.fromHex('#ffffdd'), Color.fromHex('#000011')],
    minmaxRed: [Color.fromHex('#bb3333'), Color.fromHex('#ffffdd')],
    minmaxGreen: [Color.fromHex('#777766'), Color.fromHex('#ffffdd')],
    ...
    bottom: {
        averageColor: Color.fromHex('#3f353f'),
