...
AnAbstractIllustrationOfAVirtualRealityEnviro7606152d139c4009Afc0050d9c310b1f0_1_Image.colorStats = {
    averageColor: Color.fromHex('#1f3c80'),
    lightestColor: Color.fromHex('#ccffff'),
    darkestColor: Color.fromHex('#111133'),
    minmaxWhite: [Color.fromHex('#ccffff'), Color.fromHex('#001144')],
    minmaxRed: [Color.fromHex('#884444'), Color.fromHex('#44eeff')],
    minmaxGreen: [Color.fromHex('#33bbcc'), Color.fromHex('#1122bb')],
    minmaxBlue: [Color.fromHex('#1133cc'), Color.fromHex('#ccffff')],
    mostFrequentColor: Color.fromHex('#111133'),
    mostSaturatedColor: Color.fromHex('#001144'),
    mostGroupedColor: Color.fromHex('#111144'),
    bottom: {
        averageColor: Color.fromHex('#143176'),
        lightestColor: Color.fromHex('#88eeff'),
        darkestColor: Color.fromHex('#111133'),
        minmaxWhite: [Color.fromHex('#88eeff'), Color.fromHex('#001144')],
        minmaxRed: [Color.fromHex('#443377'), Color.fromHex('#55ffff')],
        minmaxGreen: [Color.fromHex('#22aacc'), Color.fromHex('#1111aa')],
        minmaxBlue: [Color.fromHex('#1133cc'), Color.fromHex('#55ffff')],
        mostFrequentColor: Color.fromHex('#111133'),
