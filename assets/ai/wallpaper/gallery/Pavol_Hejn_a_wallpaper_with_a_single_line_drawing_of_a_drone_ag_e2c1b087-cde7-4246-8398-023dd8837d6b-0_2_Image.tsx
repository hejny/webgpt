...
AWallpaperWithASingleLineDrawingOfADroneAgE2c1b087Cde742468398023dd8837d6b0_2_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#88bb77'), Color.fromHex('#ffeeee')],
    minmaxBlue: [Color.fromHex('#115566'), Color.fromHex('#ffffee')],
    mostFrequentColor: Color.fromHex('#665522'),
    mostSaturatedColor: Color.fromHex('#004455'),
    mostGroupedColor: Color.fromHex('#224444'),
    bottom: {
        averageColor: Color.fromHex('#4e5645'),
        lightestColor: Color.fromHex('#bbccaa'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#bbccaa'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#dd7733'), Color.fromHex('#bbccaa')],
        minmaxGreen: [Color.fromHex('#447755'), Color.fromHex('#000011')],
        minmaxBlue: [Color.fromHex('#114455'), Color.fromHex('#ddcc44')],
        mostFrequentColor: Color.fromHex('#665522'),
