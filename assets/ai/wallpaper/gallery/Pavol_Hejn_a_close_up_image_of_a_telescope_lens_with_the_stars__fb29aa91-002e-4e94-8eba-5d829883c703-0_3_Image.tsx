...
ACloseUpImageOfATelescopeLensWithTheStarsFb29aa91002e4e948eba5d829883c7030_3_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#557777'), Color.fromHex('#ffddee')],
    minmaxBlue: [Color.fromHex('#1177bb'), Color.fromHex('#ffeedd')],
    ...
    bottom: {
        ...
        minmaxBlue: [Color.fromHex('#334466'), Color.fromHex('#ffeedd')],
        mostFrequentColor: Color.fromHex('#000000'),
