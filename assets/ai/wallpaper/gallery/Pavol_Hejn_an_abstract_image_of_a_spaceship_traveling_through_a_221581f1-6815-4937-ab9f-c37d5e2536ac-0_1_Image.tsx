...
AnAbstractImageOfASpaceshipTravelingThroughA221581f168154937Ab9fC37d5e2536ac0_1_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#338866'), Color.fromHex('#dd1122')],
    minmaxBlue: [Color.fromHex('#225588'), Color.fromHex('#ffcc22')],
    ...
    bottom: {
        ...
        minmaxGreen: [Color.fromHex('#448877'), Color.fromHex('#cc1122')],
