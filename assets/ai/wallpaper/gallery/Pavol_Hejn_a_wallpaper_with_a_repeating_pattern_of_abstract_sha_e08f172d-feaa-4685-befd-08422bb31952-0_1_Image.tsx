...
AWallpaperWithARepeatingPatternOfAbstractShaE08f172dFeaa4685Befd08422bb319520_1_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#dd4422'), Color.fromHex('#ffffee')],
    ...
    bottom: {
        averageColor: Color.fromHex('#5e4840'),
        lightestColor: Color.fromHex('#ffeedd'),
        darkestColor: Color.fromHex('#221100'),
        minmaxWhite: [Color.fromHex('#ffeedd'), Color.fromHex('#001111')],
        minmaxRed: [Color.fromHex('#dd4422'), Color.fromHex('#ffeedd')],
        minmaxGreen: [Color.fromHex('#22aa88'), Color.fromHex('#ffeedd')],
