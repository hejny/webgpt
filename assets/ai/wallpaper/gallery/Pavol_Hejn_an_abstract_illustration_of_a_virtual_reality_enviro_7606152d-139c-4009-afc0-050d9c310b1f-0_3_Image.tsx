...
AnAbstractIllustrationOfAVirtualRealityEnviro7606152d139c4009Afc0050d9c310b1f0_3_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#881166'), Color.fromHex('#11ccdd')],
    minmaxGreen: [Color.fromHex('#668877'), Color.fromHex('#dd44dd')],
    ...
    bottom: {
        averageColor: Color.fromHex('#173e66'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000011'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000011')],
        minmaxRed: [Color.fromHex('#881166'), Color.fromHex('#55eeff')],
