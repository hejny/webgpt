...
AWallpaperFeaturingASimpleGraphicOfADigital9ceb7010937f40e589379711b409e3330_3_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#bb7744'), Color.fromHex('#ffffff')],
    minmaxGreen: [Color.fromHex('#446655'), Color.fromHex('#ffffff')],
    minmaxBlue: [Color.fromHex('#113344'), Color.fromHex('#ffffee')],
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#996633'), Color.fromHex('#bbbb99')],
        minmaxGreen: [Color.fromHex('#777755'), Color.fromHex('#000011')],
        minmaxBlue: [Color.fromHex('#113344'), Color.fromHex('#ccbb99')],
        mostFrequentColor: Color.fromHex('#000011'),
        mostSaturatedColor: Color.fromHex('#000011'),
