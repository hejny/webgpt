...
AWallpaperWithARepeatingPatternOfAbstractSha2d93eee7F23a4bb9Bb52Ce0dc8b9b7d10_0_Image.colorStats = {
    ...
    lightestColor: Color.fromHex('#88aa99'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#cccc66'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#dd6622'), Color.fromHex('#1199aa')],
    minmaxGreen: [Color.fromHex('#88bb11'), Color.fromHex('#550066')],
    minmaxBlue: [Color.fromHex('#113377'), Color.fromHex('#ccee44')],
    mostFrequentColor: Color.fromHex('#000011'),
    mostSaturatedColor: Color.fromHex('#110011'),
    mostGroupedColor: Color.fromHex('#000000'),
    bottom: {
        averageColor: Color.fromHex('#15151c'),
        lightestColor: Color.fromHex('#994488'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#cccc66'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#994411'), Color.fromHex('#119988')],
        minmaxGreen: [Color.fromHex('#559933'), Color.fromHex('#991177')],
        minmaxBlue: [Color.fromHex('#113377'), Color.fromHex('#ccee55')],
        mostFrequentColor: Color.fromHex('#000011'),
