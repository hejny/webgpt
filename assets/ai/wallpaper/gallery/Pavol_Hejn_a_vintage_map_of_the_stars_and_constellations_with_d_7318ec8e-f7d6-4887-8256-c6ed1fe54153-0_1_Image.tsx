...
AVintageMapOfTheStarsAndConstellationsWithD7318ec8eF7d648878256C6ed1fe541530_1_Image.colorStats = {
    averageColor: Color.fromHex('#bda57d'),
    lightestColor: Color.fromHex('#ffffdd'),
    darkestColor: Color.fromHex('#222200'),
    minmaxWhite: [Color.fromHex('#ffffdd'), Color.fromHex('#222200')],
    minmaxRed: [Color.fromHex('#994433'), Color.fromHex('#ffffdd')],
    ...
    bottom: {
        ...
        minmaxWhite: [Color.fromHex('#ffeecc'), Color.fromHex('#332200')],
        minmaxRed: [Color.fromHex('#883322'), Color.fromHex('#ffeecc')],
