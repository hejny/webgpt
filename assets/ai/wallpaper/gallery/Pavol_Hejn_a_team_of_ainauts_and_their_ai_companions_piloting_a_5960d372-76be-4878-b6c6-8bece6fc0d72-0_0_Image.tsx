...
ATeamOfAinautsAndTheirAiCompanionsPilotingA5960d37276be4878B6c68bece6fc0d720_0_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#447766'), Color.fromHex('#ccffff')],
    ...
    bottom: {
        averageColor: Color.fromHex('#303538'),
        lightestColor: Color.fromHex('#ddeeee'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eeeedd'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#bb5533'), Color.fromHex('#cceeee')],
        minmaxGreen: [Color.fromHex('#66aa99'), Color.fromHex('#ffeecc')],
