...
ADigitalPaintingOfALoneAstronautStandingOnT52813773864c445fA336F22707e901360_0_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#882200'), Color.fromHex('#eeffee')],
    ...
    bottom: {
        averageColor: Color.fromHex('#36231e'),
        lightestColor: Color.fromHex('#ddddcc'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ddddcc'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#aa5522'), Color.fromHex('#ddddcc')],
        minmaxGreen: [Color.fromHex('#999977'), Color.fromHex('#110011')],
        minmaxBlue: [Color.fromHex('#665566'), Color.fromHex('#ffaa44')],
        mostFrequentColor: Color.fromHex('#000000'),
        mostSaturatedColor: Color.fromHex('#110000'),
        mostGroupedColor: Color.fromHex('#111111'),
    },
