...
AnAbstractIllustrationOfAVirtualRealityEnviroA995021970f74f2dA2b8Ff2366c5d7960_2_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#aa4422'), Color.fromHex('#33ddee')],
    minmaxGreen: [Color.fromHex('#338877'), Color.fromHex('#440011')],
    minmaxBlue: [Color.fromHex('#006688'), Color.fromHex('#eeffdd')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#000000'),
    bottom: {
        averageColor: Color.fromHex('#423029'),
        ...
        minmaxGreen: [Color.fromHex('#33aa99'), Color.fromHex('#ffeecc')],
