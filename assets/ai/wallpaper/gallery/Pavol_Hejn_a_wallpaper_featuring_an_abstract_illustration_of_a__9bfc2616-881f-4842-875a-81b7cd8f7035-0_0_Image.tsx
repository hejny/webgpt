...
AWallpaperFeaturingAnAbstractIllustrationOfA9bfc2616881f4842875a81b7cd8f70350_0_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#ee3333'), Color.fromHex('#22ffdd')],
    minmaxGreen: [Color.fromHex('#22cc66'), Color.fromHex('#ffeeff')],
    ...
    bottom: {
        averageColor: Color.fromHex('#1c1d32'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#ee3333'), Color.fromHex('#44ffcc')],
        minmaxGreen: [Color.fromHex('#22cc66'), Color.fromHex('#ffffff')],
