...
APhotographOfTheNorthernLightsWithTheGreenAA8339eff839e4ed8818bAb5ea74ca5960_2_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#663366'), Color.fromHex('#ddeeff')],
    minmaxGreen: [Color.fromHex('#229944'), Color.fromHex('#eeeeff')],
    minmaxBlue: [Color.fromHex('#555588'), Color.fromHex('#eeeeff')],
    mostFrequentColor: Color.fromHex('#112222'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#111122'),
    bottom: {
        averageColor: Color.fromHex('#27342e'),
        lightestColor: Color.fromHex('#ffffee'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffee'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#553344'), Color.fromHex('#ffffee')],
        minmaxGreen: [Color.fromHex('#559955'), Color.fromHex('#ffffee')],
