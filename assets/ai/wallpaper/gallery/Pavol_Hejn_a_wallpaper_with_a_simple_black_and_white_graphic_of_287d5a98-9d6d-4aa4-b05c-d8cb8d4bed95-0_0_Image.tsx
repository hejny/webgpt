...
AWallpaperWithASimpleBlackAndWhiteGraphicOf287d5a989d6d4aa4B05cD8cb8d4bed950_0_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#443333'), Color.fromHex('#ffffff')],
    minmaxGreen: [Color.fromHex('#556655'), Color.fromHex('#ffffff')],
    minmaxBlue: [Color.fromHex('#665566'), Color.fromHex('#ffffff')],
    ...
    bottom: {
        ...
        minmaxBlue: [Color.fromHex('#555555'), Color.fromHex('#ffffff')],
        mostFrequentColor: Color.fromHex('#000000'),
