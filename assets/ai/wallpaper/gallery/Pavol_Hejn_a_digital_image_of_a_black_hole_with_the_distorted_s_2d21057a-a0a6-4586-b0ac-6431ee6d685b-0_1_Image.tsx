...
import colorStats from './Pavol_Hejn_a_digital_image_of_a_black_hole_with_the_distorted_s_2d21057a-a0a6-4586-b0ac-6431ee6d685b-0_1.colors.json';
import content from './Pavol_Hejn_a_digital_image_of_a_black_hole_with_the_distorted_s_2d21057a-a0a6-4586-b0ac-6431ee6d685b-0_1.content.md';
...
export function ADigitalImageOfABlackHoleWithTheDistortedS2d21057aA0a64586B0ac6431ee6d685b0_1_Image(
    ...
    return (
        <Image
            ...
            src="https://cdn.midjourney.com/2d21057a-a0a6-4586-b0ac-6431ee6d685b/0_1.png"
            draggable="false"
            placeholder="blur"
...
ADigitalImageOfABlackHoleWithTheDistortedS2d21057aA0a64586B0ac6431ee6d685b0_1_Image.src = new URL(
    'https://cdn.midjourney.com/2d21057a-a0a6-4586-b0ac-6431ee6d685b/0_1.png',
);
...
ADigitalImageOfABlackHoleWithTheDistortedS2d21057aA0a64586B0ac6431ee6d685b0_1_Image.content = content;
