...
import source from './Pavol_Hejn_a_wallpaper_featuring_a_collage_of_futuristic_techno_a61d8392-6cb0-4241-aa9a-96f23c0bbb65-0_3.png';
...
AWallpaperFeaturingACollageOfFuturisticTechnoA61d83926cb04241Aa9a96f23c0bbb650_3_Image.colorStats = {
    averageColor: Color.fromHex('#222429'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#dd2200'), Color.fromHex('#44ccff')],
    minmaxGreen: [Color.fromHex('#339966'), Color.fromHex('#ff3300')],
    minmaxBlue: [Color.fromHex('#0044bb'), Color.fromHex('#ffee22')],
    mostFrequentColor: Color.fromHex('#000011'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#001111'),
    bottom: {
        averageColor: Color.fromHex('#1f191d'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#ee3311'), Color.fromHex('#eeffff')],
        minmaxGreen: [Color.fromHex('#bbaa22'), Color.fromHex('#ffeeff')],
        minmaxBlue: [Color.fromHex('#223366'), Color.fromHex('#ffcc11')],
        mostFrequentColor: Color.fromHex('#000011'),
        mostSaturatedColor: Color.fromHex('#000011'),
        mostGroupedColor: Color.fromHex('#001111'),
    },
