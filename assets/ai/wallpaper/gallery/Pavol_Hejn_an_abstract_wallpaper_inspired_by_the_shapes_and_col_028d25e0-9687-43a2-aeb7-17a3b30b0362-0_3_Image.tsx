...
AnAbstractWallpaperInspiredByTheShapesAndCol028d25e0968743a2Aeb717a3b30b03620_3_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#00aa77'), Color.fromHex('#cc0055')],
    ...
    bottom: {
        averageColor: Color.fromHex('#241e25'),
        lightestColor: Color.fromHex('#ffeedd'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffeedd'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#dd3300'), Color.fromHex('#eeeedd')],
        minmaxGreen: [Color.fromHex('#007766'), Color.fromHex('#aa1144')],
        minmaxBlue: [Color.fromHex('#116688'), Color.fromHex('#ffeedd')],
        mostFrequentColor: Color.fromHex('#001111'),
