...
AVintageMapOfTheStarsAndConstellationsWithD7318ec8eF7d648878256C6ed1fe541530_0_Image.colorStats = {
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#aa4411'), Color.fromHex('#ffffcc')],
        minmaxGreen: [Color.fromHex('#778855'), Color.fromHex('#440000')],
