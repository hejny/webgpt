...
AnIllustrationOfACyborgWithAMetallicBodyAnd322efe9bEf35430587d1Ec84d9f83ecd0_0_Image.colorStats = {
    averageColor: Color.fromHex('#1e2428'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#772211'), Color.fromHex('#77ffff')],
    minmaxGreen: [Color.fromHex('#449988'), Color.fromHex('#ffffff')],
    minmaxBlue: [Color.fromHex('#2277bb'), Color.fromHex('#ffee22')],
    ...
    bottom: {
        ...
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#995533'), Color.fromHex('#88ffff')],
        minmaxGreen: [Color.fromHex('#667766'), Color.fromHex('#ffffff')],
        minmaxBlue: [Color.fromHex('#2277bb'), Color.fromHex('#ffffff')],
        mostFrequentColor: Color.fromHex('#000000'),
        mostSaturatedColor: Color.fromHex('#110000'),
        mostGroupedColor: Color.fromHex('#000000'),
    },
