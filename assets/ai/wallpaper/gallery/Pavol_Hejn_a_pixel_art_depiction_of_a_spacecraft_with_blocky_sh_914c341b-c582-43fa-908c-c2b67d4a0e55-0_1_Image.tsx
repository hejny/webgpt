...
APixelArtDepictionOfASpacecraftWithBlockySh914c341bC58243fa908cC2b67d4a0e550_1_Image.colorStats = {
    averageColor: Color.fromHex('#4d525e'),
    ...
    minmaxGreen: [Color.fromHex('#559988'), Color.fromHex('#ffeedd')],
    minmaxBlue: [Color.fromHex('#555588'), Color.fromHex('#ffffbb')],
    mostFrequentColor: Color.fromHex('#223355'),
    mostSaturatedColor: Color.fromHex('#ff8833'),
    mostGroupedColor: Color.fromHex('#334455'),
    bottom: {
        averageColor: Color.fromHex('#414555'),
        lightestColor: Color.fromHex('#ddffee'),
        darkestColor: Color.fromHex('#001122'),
        minmaxWhite: [Color.fromHex('#ddffee'), Color.fromHex('#001122')],
        minmaxRed: [Color.fromHex('#aa3344'), Color.fromHex('#ddffee')],
        minmaxGreen: [Color.fromHex('#668877'), Color.fromHex('#ffeecc')],
        minmaxBlue: [Color.fromHex('#443366'), Color.fromHex('#ffffcc')],
        mostFrequentColor: Color.fromHex('#223355'),
