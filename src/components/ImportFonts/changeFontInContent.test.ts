...
import { changeFontsInContent } from './changeFontInContent';

describe('changeFontsInContent', () => {
    it('should add font into simple markdown content', () => {
        expect(
    ...
    it('should add font into real markdown content', () => {
        expect(
            changeFontsInContent(
                spaceTrim(`
                    # Ocean Workspace
    ...
    it('should swap font from real markdown content', () => {
        expect(
            changeFontsInContent(
                spaceTrim(`
                    <!--font:Cabin-->
