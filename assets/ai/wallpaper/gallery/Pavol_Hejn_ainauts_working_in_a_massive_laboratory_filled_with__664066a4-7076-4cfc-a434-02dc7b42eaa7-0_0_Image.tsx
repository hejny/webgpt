...
AinautsWorkingInAMassiveLaboratoryFilledWith664066a470764cfcA43402dc7b42eaa70_0_Image.colorStats = {
    averageColor: Color.fromHex('#07454a'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#552211'), Color.fromHex('#22eeee')],
    ...
    bottom: {
        averageColor: Color.fromHex('#06434b'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#552211'), Color.fromHex('#22eedd')],
        minmaxGreen: [Color.fromHex('#006644'), Color.fromHex('#ffffff')],
