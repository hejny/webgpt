...
ADigitalImageOfAGalaxyCollisionWithSwirlingF91b24a5B84c4babBaccBd82e09756b00_3_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#668844'), Color.fromHex('#990011')],
    minmaxBlue: [Color.fromHex('#554488'), Color.fromHex('#ffffee')],
    mostFrequentColor: Color.fromHex('#001111'),
    mostSaturatedColor: Color.fromHex('#001122'),
    mostGroupedColor: Color.fromHex('#220011'),
    bottom: {
        averageColor: Color.fromHex('#332127'),
        lightestColor: Color.fromHex('#99cccc'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffcc88'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#cc2211'), Color.fromHex('#99cccc')],
        minmaxGreen: [Color.fromHex('#668877'), Color.fromHex('#bb1111')],
        minmaxBlue: [Color.fromHex('#445588'), Color.fromHex('#ffcc88')],
        mostFrequentColor: Color.fromHex('#001111'),
