...
AWallpaperFeaturingACollageOfFuturisticTechno1f096dfB6524e89B69b16203b15e2a603_3_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#443322'), Color.fromHex('#ddeeee')],
    minmaxGreen: [Color.fromHex('#338877'), Color.fromHex('#ddeeee')],
    minmaxBlue: [Color.fromHex('#226677'), Color.fromHex('#ddeedd')],
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#444433'), Color.fromHex('#ddeeee')],
        minmaxGreen: [Color.fromHex('#447766'), Color.fromHex('#eeeeee')],
        minmaxBlue: [Color.fromHex('#336677'), Color.fromHex('#eeeeee')],
        mostFrequentColor: Color.fromHex('#000000'),
        mostSaturatedColor: Color.fromHex('#001111'),
        mostGroupedColor: Color.fromHex('#000000'),
    },
