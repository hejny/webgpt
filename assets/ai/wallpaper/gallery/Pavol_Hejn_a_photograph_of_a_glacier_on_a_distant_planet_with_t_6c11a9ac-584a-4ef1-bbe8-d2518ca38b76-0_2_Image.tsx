...
APhotographOfAGlacierOnADistantPlanetWithT6c11a9ac584a4ef1Bbe8D2518ca38b760_2_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#448888'), Color.fromHex('#ddddee')],
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#444444'), Color.fromHex('#bbddee')],
        minmaxGreen: [Color.fromHex('#448888'), Color.fromHex('#ddddee')],
        minmaxBlue: [Color.fromHex('#336677'), Color.fromHex('#dddddd')],
        mostFrequentColor: Color.fromHex('#001111'),
