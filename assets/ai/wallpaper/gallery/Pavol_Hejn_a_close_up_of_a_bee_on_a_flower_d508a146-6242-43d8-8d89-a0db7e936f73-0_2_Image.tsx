...
import content from './Pavol_Hejn_a_close_up_of_a_bee_on_a_flower_d508a146-6242-43d8-8d89-a0db7e936f73-0_2.content.md';
...
export function ACloseUpOfABeeOnAFlowerD508a146624243d88d89A0db7e936f730_2_Image(props: IWallpaperComponentProps) {
    ...
    return (
        <Image
            ...
            src="https://cdn.midjourney.com/d508a146-6242-43d8-8d89-a0db7e936f73/0_2.png"
            draggable="false"
            placeholder="blur"
...
ACloseUpOfABeeOnAFlowerD508a146624243d88d89A0db7e936f730_2_Image.src = new URL(
    'https://cdn.midjourney.com/d508a146-6242-43d8-8d89-a0db7e936f73/0_2.png',
);
...
ACloseUpOfABeeOnAFlowerD508a146624243d88d89A0db7e936f730_2_Image.content = content;
