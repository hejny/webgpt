...
APosterStyleImageOfAMissionToMarsWithBold6e6533f577744664A6c18ebb09cefb820_1_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#ee2211'), Color.fromHex('#eeeebb')],
    minmaxGreen: [Color.fromHex('#558866'), Color.fromHex('#ee2211')],
    minmaxBlue: [Color.fromHex('#113355'), Color.fromHex('#ffee99')],
    mostFrequentColor: Color.fromHex('#110011'),
    mostSaturatedColor: Color.fromHex('#004455'),
    mostGroupedColor: Color.fromHex('#110011'),
    bottom: {
        averageColor: Color.fromHex('#7c241e'),
        lightestColor: Color.fromHex('#cccccc'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffeeaa'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#ee2211'), Color.fromHex('#eeeeaa')],
        minmaxGreen: [Color.fromHex('#777766'), Color.fromHex('#ee2211')],
        minmaxBlue: [Color.fromHex('#552244'), Color.fromHex('#ffee99')],
        mostFrequentColor: Color.fromHex('#110011'),
