...
ARealisticPhotographOfANebulaWithBrightColor58b2a5ec382943ebAee22d9dde7bae200_2_Image.colorStats = {
    averageColor: Color.fromHex('#3c3438'),
    lightestColor: Color.fromHex('#ffeeee'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffeeee'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#cc2211'), Color.fromHex('#ffeeee')],
    minmaxGreen: [Color.fromHex('#228866'), Color.fromHex('#ffddee')],
    minmaxBlue: [Color.fromHex('#334477'), Color.fromHex('#ffeeaa')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#110011'),
    bottom: {
        averageColor: Color.fromHex('#422c31'),
        lightestColor: Color.fromHex('#ddeeee'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ddeeee'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#bb1122'), Color.fromHex('#ddeeee')],
        minmaxGreen: [Color.fromHex('#669988'), Color.fromHex('#bb1122')],
        minmaxBlue: [Color.fromHex('#444477'), Color.fromHex('#ffcc55')],
        mostFrequentColor: Color.fromHex('#000000'),
