...
AMinimalistGraphicOfAFuturisticWorkspaceWithE06eece08eb14104A195A3f2518607d10_1_Image.colorStats = {
    averageColor: Color.fromHex('#637883'),
    lightestColor: Color.fromHex('#ffeeee'),
    darkestColor: Color.fromHex('#001111'),
    minmaxWhite: [Color.fromHex('#ffffee'), Color.fromHex('#000011')],
    minmaxRed: [Color.fromHex('#222244'), Color.fromHex('#ffffee')],
    minmaxGreen: [Color.fromHex('#449999'), Color.fromHex('#ffeeee')],
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#334455'), Color.fromHex('#bbeeee')],
