...
ACloseUpImageOfARobotSEyeWithNeonGreenAcAb2942571d244a28Ae28C215a17e7cdb0_2_Image.colorStats = {
    averageColor: Color.fromHex('#062218'),
    lightestColor: Color.fromHex('#eeffee'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#eeffee'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#995544'), Color.fromHex('#00ffdd')],
    minmaxGreen: [Color.fromHex('#11ee22'), Color.fromHex('#eeffee')],
    minmaxBlue: [Color.fromHex('#0077aa'), Color.fromHex('#eeffdd')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#000000'),
    bottom: {
        averageColor: Color.fromHex('#031b12'),
        lightestColor: Color.fromHex('#99bbcc'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#99bbcc'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#885533'), Color.fromHex('#00ffdd')],
        minmaxGreen: [Color.fromHex('#00dd33'), Color.fromHex('#110011')],
        minmaxBlue: [Color.fromHex('#006688'), Color.fromHex('#22cc11')],
        mostFrequentColor: Color.fromHex('#000000'),
