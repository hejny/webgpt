...
APhotographOfALavaFlowOnAVolcanicPlanetWit6fe56b8b054d4c2aA84f29e37be59e990_2_Image.colorStats = {
    averageColor: Color.fromHex('#2e1c21'),
    lightestColor: Color.fromHex('#eeddbb'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#eeddbb'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#dd2200'), Color.fromHex('#ffeeaa')],
    minmaxGreen: [Color.fromHex('#556666'), Color.fromHex('#bb0000')],
    minmaxBlue: [Color.fromHex('#554466'), Color.fromHex('#ffeeaa')],
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#dd2211'), Color.fromHex('#999999')],
        minmaxGreen: [Color.fromHex('#777777'), Color.fromHex('#dd2211')],
        minmaxBlue: [Color.fromHex('#554466'), Color.fromHex('#ff7722')],
        mostFrequentColor: Color.fromHex('#000000'),
