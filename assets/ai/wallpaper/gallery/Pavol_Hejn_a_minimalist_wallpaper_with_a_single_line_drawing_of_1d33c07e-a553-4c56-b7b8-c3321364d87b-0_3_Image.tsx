...
AMinimalistWallpaperWithASingleLineDrawingOf1d33c07eA5534c56B7b8C3321364d87b0_3_Image.colorStats = {
    ...
    darkestColor: Color.fromHex('#991111'),
    minmaxWhite: [Color.fromHex('#eeddee'), Color.fromHex('#221144')],
    minmaxRed: [Color.fromHex('#ee1111'), Color.fromHex('#bbdddd')],
    minmaxGreen: [Color.fromHex('#445555'), Color.fromHex('#ff1122')],
    minmaxBlue: [Color.fromHex('#443388'), Color.fromHex('#ffdddd')],
    mostFrequentColor: Color.fromHex('#ff3322'),
    mostSaturatedColor: Color.fromHex('#ee2200'),
    mostGroupedColor: Color.fromHex('#ff3322'),
    bottom: {
        averageColor: Color.fromHex('#d9867f'),
        lightestColor: Color.fromHex('#ddccee'),
        darkestColor: Color.fromHex('#772222'),
        minmaxWhite: [Color.fromHex('#ffdddd'), Color.fromHex('#221144')],
        minmaxRed: [Color.fromHex('#ee1122'), Color.fromHex('#eedddd')],
        minmaxGreen: [Color.fromHex('#555577'), Color.fromHex('#ff1133')],
        minmaxBlue: [Color.fromHex('#443388'), Color.fromHex('#ffddbb')],
        mostFrequentColor: Color.fromHex('#ff3322'),
        mostSaturatedColor: Color.fromHex('#ff2211'),
        mostGroupedColor: Color.fromHex('#ff3322'),
    },
