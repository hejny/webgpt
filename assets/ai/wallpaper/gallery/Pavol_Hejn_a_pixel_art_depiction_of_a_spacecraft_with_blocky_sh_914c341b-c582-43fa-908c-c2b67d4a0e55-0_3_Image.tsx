...
APixelArtDepictionOfASpacecraftWithBlockySh914c341bC58243fa908cC2b67d4a0e550_3_Image.colorStats = {
    averageColor: Color.fromHex('#212632'),
    lightestColor: Color.fromHex('#eeffff'),
    darkestColor: Color.fromHex('#110000'),
    minmaxWhite: [Color.fromHex('#eeffff'), Color.fromHex('#000011')],
    minmaxRed: [Color.fromHex('#bb3322'), Color.fromHex('#bbffff')],
    minmaxGreen: [Color.fromHex('#aaee44'), Color.fromHex('#eeffff')],
    minmaxBlue: [Color.fromHex('#7744aa'), Color.fromHex('#eedd33')],
    mostFrequentColor: Color.fromHex('#112233'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#000011'),
    bottom: {
        averageColor: Color.fromHex('#181a26'),
        lightestColor: Color.fromHex('#99bbcc'),
        darkestColor: Color.fromHex('#000011'),
        minmaxWhite: [Color.fromHex('#bbeeaa'), Color.fromHex('#000011')],
        minmaxRed: [Color.fromHex('#dd4433'), Color.fromHex('#bbeeaa')],
        minmaxGreen: [Color.fromHex('#aaee44'), Color.fromHex('#220022')],
        minmaxBlue: [Color.fromHex('#334466'), Color.fromHex('#dddd33')],
        mostFrequentColor: Color.fromHex('#112233'),
        mostSaturatedColor: Color.fromHex('#000011'),
        mostGroupedColor: Color.fromHex('#000011'),
    },
