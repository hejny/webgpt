...
export function APosterStyleImageOfAMissionToMarsWithBold6e6533f577744664A6c18ebb09cefb820_1_Image() {
    return (
        <Image
            ...
            src={a_poster_style_image_of_a_mission_to_mars_with_bold_6e6533f5_7774_4664_a6c1_8ebb09cefb82_0_1}
            draggable="false"
            placeholder="blur"
...
APosterStyleImageOfAMissionToMarsWithBold6e6533f577744664A6c18ebb09cefb820_1_Image.colorStats = {
    ...
    mostFrequentColor: Color.fromHex('#170710'),
    leastFrequentColor: Color.fromHex('#06404d'),
