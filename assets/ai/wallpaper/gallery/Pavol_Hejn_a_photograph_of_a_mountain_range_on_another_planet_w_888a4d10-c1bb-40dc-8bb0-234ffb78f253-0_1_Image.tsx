...
APhotographOfAMountainRangeOnAnotherPlanetW888a4d10C1bb40dc8bb0234ffb78f2530_1_Image.colorStats = {
    ...
    bottom: {
        averageColor: Color.fromHex('#4d3127'),
        lightestColor: Color.fromHex('#eeaa77'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eeaa77'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#994411'), Color.fromHex('#001122')],
        minmaxGreen: [Color.fromHex('#666655'), Color.fromHex('#330000')],
        minmaxBlue: [Color.fromHex('#444455'), Color.fromHex('#ee9944')],
        mostFrequentColor: Color.fromHex('#332222'),
