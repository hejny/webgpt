...
APhotographOfALavaFlowOnAVolcanicPlanetWit501ae47cE9874f3d9f11199be5534df80_0_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#ee1100'), Color.fromHex('#eebbaa')],
    minmaxGreen: [Color.fromHex('#556666'), Color.fromHex('#dd0000')],
    minmaxBlue: [Color.fromHex('#554466'), Color.fromHex('#ffcc00')],
    mostFrequentColor: Color.fromHex('#000011'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#111111'),
    bottom: {
        averageColor: Color.fromHex('#3b1e20'),
        lightestColor: Color.fromHex('#dd9966'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffbb44'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#ee1100'), Color.fromHex('#001111')],
        minmaxGreen: [Color.fromHex('#555555'), Color.fromHex('#ee1100')],
