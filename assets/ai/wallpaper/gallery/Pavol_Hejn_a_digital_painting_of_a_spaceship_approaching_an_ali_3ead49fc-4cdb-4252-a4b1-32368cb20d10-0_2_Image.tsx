...
ADigitalPaintingOfASpaceshipApproachingAnAli3ead49fc4cdb4252A4b132368cb20d100_2_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#cc5500'), Color.fromHex('#eeffff')],
    minmaxGreen: [Color.fromHex('#669955'), Color.fromHex('#eeffff')],
    minmaxBlue: [Color.fromHex('#116688'), Color.fromHex('#eeffff')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#111100'),
    mostGroupedColor: Color.fromHex('#112222'),
    bottom: {
        averageColor: Color.fromHex('#282d1e'),
        lightestColor: Color.fromHex('#88cccc'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ddcc88'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#cc5500'), Color.fromHex('#77cccc')],
        minmaxGreen: [Color.fromHex('#779955'), Color.fromHex('#110000')],
        minmaxBlue: [Color.fromHex('#336688'), Color.fromHex('#ccbb44')],
        mostFrequentColor: Color.fromHex('#000000'),
        mostSaturatedColor: Color.fromHex('#111100'),
