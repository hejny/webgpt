...
ACloseUpImageOfARobotSEyeWithNeonGreenAc266438f7F004428aAdc4Ee13a5139e630_3_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#dd3300'), Color.fromHex('#00ff99')],
    minmaxGreen: [Color.fromHex('#11ee22'), Color.fromHex('#ffeeff')],
    ...
    bottom: {
        ...
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#553322'), Color.fromHex('#00ff99')],
        minmaxGreen: [Color.fromHex('#11ee22'), Color.fromHex('#ffffff')],
        minmaxBlue: [Color.fromHex('#446699'), Color.fromHex('#ffffff')],
        mostFrequentColor: Color.fromHex('#000000'),
