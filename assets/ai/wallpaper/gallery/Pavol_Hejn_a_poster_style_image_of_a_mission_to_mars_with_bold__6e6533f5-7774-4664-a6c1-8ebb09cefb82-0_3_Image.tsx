...
APosterStyleImageOfAMissionToMarsWithBold6e6533f577744664A6c18ebb09cefb820_3_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#ee2211'), Color.fromHex('#99ddee')],
    minmaxGreen: [Color.fromHex('#779966'), Color.fromHex('#ee2211')],
    minmaxBlue: [Color.fromHex('#006699'), Color.fromHex('#ffee99')],
    mostFrequentColor: Color.fromHex('#001122'),
    mostSaturatedColor: Color.fromHex('#001122'),
    mostGroupedColor: Color.fromHex('#001122'),
    bottom: {
        averageColor: Color.fromHex('#2b1a25'),
        lightestColor: Color.fromHex('#aabbbb'),
        darkestColor: Color.fromHex('#330000'),
        minmaxWhite: [Color.fromHex('#ffdd99'), Color.fromHex('#000011')],
        minmaxRed: [Color.fromHex('#ee3322'), Color.fromHex('#aaeebb')],
        minmaxGreen: [Color.fromHex('#aaeebb'), Color.fromHex('#ee3322')],
        minmaxBlue: [Color.fromHex('#554466'), Color.fromHex('#ffdd99')],
        mostFrequentColor: Color.fromHex('#001122'),
        mostSaturatedColor: Color.fromHex('#001122'),
        mostGroupedColor: Color.fromHex('#001122'),
    },
