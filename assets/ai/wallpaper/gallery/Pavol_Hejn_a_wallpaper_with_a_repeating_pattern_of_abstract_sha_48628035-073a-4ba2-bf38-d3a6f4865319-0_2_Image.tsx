...
AWallpaperWithARepeatingPatternOfAbstractSha48628035073a4ba2Bf38D3a6f48653190_2_Image.colorStats = {
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#bb3311'), Color.fromHex('#bbccaa')],
        minmaxGreen: [Color.fromHex('#557766'), Color.fromHex('#000022')],
        minmaxBlue: [Color.fromHex('#002255'), Color.fromHex('#eebb66')],
        mostFrequentColor: Color.fromHex('#111111'),
        mostSaturatedColor: Color.fromHex('#001111'),
        mostGroupedColor: Color.fromHex('#111111'),
    },
