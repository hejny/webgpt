...
AClearBeautifulSkyWithBeautifulSunsetSkyInT87a7de15b0b4bee825895052d2a32be02_2_Image.colorStats = {
    averageColor: Color.fromHex('#685b5e'),
    lightestColor: Color.fromHex('#eebbbb'),
    darkestColor: Color.fromHex('#001111'),
    minmaxWhite: [Color.fromHex('#eeccbb'), Color.fromHex('#000011')],
    minmaxRed: [Color.fromHex('#bb4455'), Color.fromHex('#ddccbb')],
    minmaxGreen: [Color.fromHex('#556633'), Color.fromHex('#ee88aa')],
    minmaxBlue: [Color.fromHex('#445577'), Color.fromHex('#eeccbb')],
    mostFrequentColor: Color.fromHex('#111111'),
    mostSaturatedColor: Color.fromHex('#001111'),
    mostGroupedColor: Color.fromHex('#ccaabb'),
    bottom: {
        averageColor: Color.fromHex('#2c3027'),
        lightestColor: Color.fromHex('#999999'),
        darkestColor: Color.fromHex('#001111'),
        minmaxWhite: [Color.fromHex('#999999'), Color.fromHex('#001111')],
        minmaxRed: [Color.fromHex('#664433'), Color.fromHex('#999999')],
        minmaxGreen: [Color.fromHex('#446633'), Color.fromHex('#111122')],
        minmaxBlue: [Color.fromHex('#555566'), Color.fromHex('#443311')],
        mostFrequentColor: Color.fromHex('#111111'),
        mostSaturatedColor: Color.fromHex('#001111'),
