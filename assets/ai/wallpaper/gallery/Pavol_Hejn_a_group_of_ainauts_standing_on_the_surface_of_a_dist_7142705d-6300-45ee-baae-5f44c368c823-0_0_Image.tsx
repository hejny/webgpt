...
AGroupOfAinautsStandingOnTheSurfaceOfADist7142705d630045eeBaae5f44c368c8230_0_Image.colorStats = {
    averageColor: Color.fromHex('#787f88'),
    ...
    minmaxBlue: [Color.fromHex('#226688'), Color.fromHex('#eeeedd')],
    mostFrequentColor: Color.fromHex('#221111'),
    mostSaturatedColor: Color.fromHex('#112244'),
    mostGroupedColor: Color.fromHex('#333344'),
    bottom: {
        averageColor: Color.fromHex('#7d7273'),
        lightestColor: Color.fromHex('#eeeeee'),
        darkestColor: Color.fromHex('#111111'),
        minmaxWhite: [Color.fromHex('#eeeeee'), Color.fromHex('#111111')],
        minmaxRed: [Color.fromHex('#885555'), Color.fromHex('#ddeeee')],
        minmaxGreen: [Color.fromHex('#667777'), Color.fromHex('#eeddee')],
        minmaxBlue: [Color.fromHex('#2266aa'), Color.fromHex('#eeeedd')],
        mostFrequentColor: Color.fromHex('#221111'),
        mostSaturatedColor: Color.fromHex('#2266aa'),
