...
AWallpaperFeaturingADigitalRenderingOfAQuantC268f290A1094d1bBa4eB27ccc52a5250_1_Image.colorStats = {
    averageColor: Color.fromHex('#759287'),
    lightestColor: Color.fromHex('#eeffdd'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#eeffdd'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#bb6633'), Color.fromHex('#eeffdd')],
    minmaxGreen: [Color.fromHex('#558866'), Color.fromHex('#eeffdd')],
    minmaxBlue: [Color.fromHex('#225566'), Color.fromHex('#ffffbb')],
    ...
    bottom: {
        ...
        minmaxWhite: [Color.fromHex('#eeddbb'), Color.fromHex('#223344')],
        minmaxRed: [Color.fromHex('#776633'), Color.fromHex('#ccddcc')],
        minmaxGreen: [Color.fromHex('#338866'), Color.fromHex('#eeddbb')],
        minmaxBlue: [Color.fromHex('#336677'), Color.fromHex('#eeddaa')],
        mostFrequentColor: Color.fromHex('#558888'),
        mostSaturatedColor: Color.fromHex('#338866'),
