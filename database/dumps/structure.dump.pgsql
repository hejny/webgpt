...
--
-- Name: PromptExecution_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public."PromptExecution" ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."PromptExecution_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: PromptExecution PromptExecution_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PromptExecution"
    ADD CONSTRAINT "PromptExecution_pkey" PRIMARY KEY (id);
...
--
-- Name: SEQUENCE "PromptExecution_id_seq"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public."PromptExecution_id_seq" TO anon;
GRANT ALL ON SEQUENCE public."PromptExecution_id_seq" TO authenticated;
GRANT ALL ON SEQUENCE public."PromptExecution_id_seq" TO service_role;
