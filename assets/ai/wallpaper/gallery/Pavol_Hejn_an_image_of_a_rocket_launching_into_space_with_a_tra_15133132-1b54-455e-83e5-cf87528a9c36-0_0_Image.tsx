...
AnImageOfARocketLaunchingIntoSpaceWithATra151331321b54455e83e5Cf87528a9c360_0_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#ee4422'), Color.fromHex('#ffffff')],
    ...
    bottom: {
        averageColor: Color.fromHex('#54404e'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000022'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000022')],
        minmaxRed: [Color.fromHex('#ee4433'), Color.fromHex('#eeffff')],
        minmaxGreen: [Color.fromHex('#998877'), Color.fromHex('#ffffff')],
