...
AStylizedIllustrationOfACyberneticOrganismWitd7d60dd1e7f49e0B1bc5f274c109e4a01_1_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#aa6622'), Color.fromHex('#33ffdd')],
    minmaxGreen: [Color.fromHex('#33cc88'), Color.fromHex('#ffffee')],
    minmaxBlue: [Color.fromHex('#225577'), Color.fromHex('#eeee33')],
    mostFrequentColor: Color.fromHex('#112233'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#001111'),
    bottom: {
        averageColor: Color.fromHex('#0c1418'),
        lightestColor: Color.fromHex('#55ddff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#77eeee'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#664422'), Color.fromHex('#33ddee')],
        minmaxGreen: [Color.fromHex('#55aa77'), Color.fromHex('#000022')],
        minmaxBlue: [Color.fromHex('#336699'), Color.fromHex('#bbaa66')],
        mostFrequentColor: Color.fromHex('#112233'),
