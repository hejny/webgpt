...
APhotographOfAMeteorShowerWithBrightStreaksA687fcef56574e8b8a37E7839d797d0e0_0_Image.colorStats = {
    averageColor: Color.fromHex('#3f3030'),
    lightestColor: Color.fromHex('#ffddcc'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffddcc'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#994422'), Color.fromHex('#ffddcc')],
    minmaxGreen: [Color.fromHex('#887766'), Color.fromHex('#ffddcc')],
    minmaxBlue: [Color.fromHex('#555566'), Color.fromHex('#ffcc77')],
    mostFrequentColor: Color.fromHex('#000011'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#222222'),
    bottom: {
        averageColor: Color.fromHex('#4b322c'),
        lightestColor: Color.fromHex('#ffddcc'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffddcc'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#994411'), Color.fromHex('#ffddcc')],
        minmaxGreen: [Color.fromHex('#555544'), Color.fromHex('#ffddcc')],
        minmaxBlue: [Color.fromHex('#554455'), Color.fromHex('#ffcc77')],
        mostFrequentColor: Color.fromHex('#000011'),
