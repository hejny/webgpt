...
AnIllustrationOfARoboticExplorerWithMetallicEd76f6f967224c458c699918c688c7790_1_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#337766'), Color.fromHex('#110011')],
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#775544'), Color.fromHex('#ccccbb')],
        minmaxGreen: [Color.fromHex('#556644'), Color.fromHex('#110000')],
        minmaxBlue: [Color.fromHex('#335555'), Color.fromHex('#ccccbb')],
        mostFrequentColor: Color.fromHex('#334444'),
        mostSaturatedColor: Color.fromHex('#221100'),
        mostGroupedColor: Color.fromHex('#222222'),
    },
