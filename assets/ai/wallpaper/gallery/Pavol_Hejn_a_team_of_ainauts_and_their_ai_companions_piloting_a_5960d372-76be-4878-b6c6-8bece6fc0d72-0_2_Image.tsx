...
ATeamOfAinautsAndTheirAiCompanionsPilotingA5960d37276be4878B6c68bece6fc0d720_2_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#449999'), Color.fromHex('#eeeeff')],
    minmaxBlue: [Color.fromHex('#1166aa'), Color.fromHex('#eeffff')],
    mostFrequentColor: Color.fromHex('#111111'),
    mostSaturatedColor: Color.fromHex('#001111'),
    mostGroupedColor: Color.fromHex('#111111'),
    bottom: {
        averageColor: Color.fromHex('#333e47'),
        lightestColor: Color.fromHex('#ddeeee'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eeeedd'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#aa5533'), Color.fromHex('#cceeee')],
