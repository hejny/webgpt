...
export function ADigitalIllustrationOfACityOnADistantPlanet719bc302049147aa8bd4986ff45dec130_2_Image() {
    return (
        <Image
            ...
            src={a_digital_illustration_of_a_city_on_a_distant_planet_719bc302_0491_47aa_8bd4_986ff45dec13_0_2}
            draggable="false"
            placeholder="blur"
...
ADigitalIllustrationOfACityOnADistantPlanet719bc302049147aa8bd4986ff45dec130_2_Image.colorStats = {
    ...
    mostFrequentColor: Color.fromHex('#040403'),
    leastFrequentColor: Color.fromHex('#0d0e16'),
