...
ADigitalImageOfAGalaxyCollisionWithSwirlingF91b24a5B84c4babBaccBd82e09756b00_2_Image.colorStats = {
    ...
    bottom: {
        averageColor: Color.fromHex('#403324'),
        lightestColor: Color.fromHex('#eeddcc'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eeddcc'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#aa3311'), Color.fromHex('#22aabb')],
        minmaxGreen: [Color.fromHex('#118888'), Color.fromHex('#881111')],
        minmaxBlue: [Color.fromHex('#115577'), Color.fromHex('#ffdd44')],
        mostFrequentColor: Color.fromHex('#001111'),
