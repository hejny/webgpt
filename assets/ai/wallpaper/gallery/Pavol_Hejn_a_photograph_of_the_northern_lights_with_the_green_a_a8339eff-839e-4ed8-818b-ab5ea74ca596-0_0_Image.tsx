...
APhotographOfTheNorthernLightsWithTheGreenAA8339eff839e4ed8818bAb5ea74ca5960_0_Image.colorStats = {
    ...
    lightestColor: Color.fromHex('#ccbbdd'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#bbddcc'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#773377'), Color.fromHex('#bbddcc')],
    minmaxGreen: [Color.fromHex('#559944'), Color.fromHex('#110011')],
    minmaxBlue: [Color.fromHex('#663377'), Color.fromHex('#bbddaa')],
    mostFrequentColor: Color.fromHex('#111111'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#111122'),
    bottom: {
        averageColor: Color.fromHex('#212c2d'),
        lightestColor: Color.fromHex('#bbddbb'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#bbddbb'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#664455'), Color.fromHex('#aaddbb')],
        minmaxGreen: [Color.fromHex('#559944'), Color.fromHex('#110011')],
        minmaxBlue: [Color.fromHex('#553366'), Color.fromHex('#bbddaa')],
        mostFrequentColor: Color.fromHex('#111111'),
