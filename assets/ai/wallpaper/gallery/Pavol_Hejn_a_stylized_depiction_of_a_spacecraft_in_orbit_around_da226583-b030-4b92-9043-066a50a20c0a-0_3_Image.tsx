...
AStylizedDepictionOfASpacecraftInOrbitAroundDa226583B0304b929043066a50a20c0a0_3_Image.colorStats = {
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#552211'), Color.fromHex('#ccddee')],
        minmaxGreen: [Color.fromHex('#666644'), Color.fromHex('#000011')],
        minmaxBlue: [Color.fromHex('#446677'), Color.fromHex('#ccddee')],
        mostFrequentColor: Color.fromHex('#000000'),
        mostSaturatedColor: Color.fromHex('#000011'),
        mostGroupedColor: Color.fromHex('#000000'),
    },
