...
import source from './Pavol_Hejn_a_black_and_white_outline_of_an_astronaut_exploring__a829bdcc-6e85-492c-a8d4-4155cb6c977f-0_2.png';
...
ABlackAndWhiteOutlineOfAnAstronautExploringA829bdcc6e85492cA8d44155cb6c977f0_2_Image.colorStats = {
    averageColor: Color.fromHex('#888887'),
    ...
    bottom: {
        averageColor: Color.fromHex('#acabab'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#554444'), Color.fromHex('#eeffff')],
