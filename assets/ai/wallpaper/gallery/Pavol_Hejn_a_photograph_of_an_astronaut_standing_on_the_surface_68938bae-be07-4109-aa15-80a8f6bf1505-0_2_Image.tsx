...
APhotographOfAnAstronautStandingOnTheSurface68938baeBe074109Aa1580a8f6bf15050_2_Image.colorStats = {
    averageColor: Color.fromHex('#35393e'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#aa6655'), Color.fromHex('#ddffff')],
    minmaxGreen: [Color.fromHex('#337766'), Color.fromHex('#ffeeff')],
    minmaxBlue: [Color.fromHex('#223366'), Color.fromHex('#ffffdd')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#000000'),
    bottom: {
        averageColor: Color.fromHex('#474a4f'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#774433'), Color.fromHex('#eeffff')],
        minmaxGreen: [Color.fromHex('#77bb99'), Color.fromHex('#ffffff')],
