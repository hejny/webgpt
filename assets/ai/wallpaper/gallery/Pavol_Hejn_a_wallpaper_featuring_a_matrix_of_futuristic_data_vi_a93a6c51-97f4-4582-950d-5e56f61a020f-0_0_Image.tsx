...
AWallpaperFeaturingAMatrixOfFuturisticDataViA93a6c5197f44582950d5e56f61a020f0_0_Image.colorStats = {
    ...
    bottom: {
        ...
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#77aaaa'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#553333'), Color.fromHex('#44aaaa')],
        minmaxGreen: [Color.fromHex('#337744'), Color.fromHex('#110011')],
        minmaxBlue: [Color.fromHex('#224466'), Color.fromHex('#001100')],
        mostFrequentColor: Color.fromHex('#001122'),
