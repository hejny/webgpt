...
AWallpaperFeaturingAStylizedIllustrationOfAD6f5c971b6b004986B9c721175b40e8470_3_Image.colorStats = {
    averageColor: Color.fromHex('#37383f'),
    ...
    bottom: {
        averageColor: Color.fromHex('#201b27'),
        lightestColor: Color.fromHex('#4477aa'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#cc9955'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#cc3333'), Color.fromHex('#0099aa')],
        minmaxGreen: [Color.fromHex('#778855'), Color.fromHex('#cc3333')],
        minmaxBlue: [Color.fromHex('#114488'), Color.fromHex('#ee9933')],
        mostFrequentColor: Color.fromHex('#111133'),
        mostSaturatedColor: Color.fromHex('#001122'),
