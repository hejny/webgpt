...
AWallpaperWithASimpleIllustrationOfAFuturist60e6b1544bed47d98a6bFce5b93944e10_3_Image.colorStats = {
    averageColor: Color.fromHex('#13151a'),
    lightestColor: Color.fromHex('#eeffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#eeffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#774433'), Color.fromHex('#bbffff')],
    minmaxGreen: [Color.fromHex('#446655'), Color.fromHex('#eeffff')],
    ...
    bottom: {
        ...
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eeffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#775544'), Color.fromHex('#bbffff')],
        minmaxGreen: [Color.fromHex('#336666'), Color.fromHex('#eeffff')],
        minmaxBlue: [Color.fromHex('#336688'), Color.fromHex('#eeffff')],
        mostFrequentColor: Color.fromHex('#110000'),
