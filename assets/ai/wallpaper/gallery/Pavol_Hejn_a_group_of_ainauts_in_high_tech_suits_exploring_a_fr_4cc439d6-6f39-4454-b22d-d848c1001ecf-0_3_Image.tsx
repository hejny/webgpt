...
AGroupOfAinautsInHighTechSuitsExploringAFr4cc439d66f394454B22dD848c1001ecf0_3_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#665555'), Color.fromHex('#bbeeee')],
    ...
    bottom: {
        averageColor: Color.fromHex('#627e90'),
        lightestColor: Color.fromHex('#ccddee'),
        darkestColor: Color.fromHex('#112222'),
        minmaxWhite: [Color.fromHex('#ccddee'), Color.fromHex('#111122')],
        minmaxRed: [Color.fromHex('#554444'), Color.fromHex('#bbddee')],
        minmaxGreen: [Color.fromHex('#557777'), Color.fromHex('#ccddee')],
        minmaxBlue: [Color.fromHex('#335577'), Color.fromHex('#ccdddd')],
        mostFrequentColor: Color.fromHex('#556677'),
