...
AGroupOfAinautsStandingOnTheSurfaceOfAMass83a10a2Afb54157811986fdfb29899d01_1_Image.colorStats = {
    ...
    minmaxBlue: [Color.fromHex('#666699'), Color.fromHex('#ffffff')],
    mostFrequentColor: Color.fromHex('#111111'),
    mostSaturatedColor: Color.fromHex('#110011'),
    mostGroupedColor: Color.fromHex('#333333'),
    bottom: {
        averageColor: Color.fromHex('#5a4337'),
        lightestColor: Color.fromHex('#eeeeee'),
        darkestColor: Color.fromHex('#110000'),
        minmaxWhite: [Color.fromHex('#eeeeee'), Color.fromHex('#110000')],
        minmaxRed: [Color.fromHex('#bb5533'), Color.fromHex('#eeeeee')],
        minmaxGreen: [Color.fromHex('#556655'), Color.fromHex('#eeeeee')],
        minmaxBlue: [Color.fromHex('#445577'), Color.fromHex('#eeeeee')],
        mostFrequentColor: Color.fromHex('#111111'),
        mostSaturatedColor: Color.fromHex('#110011'),
