...
AGroupOfAinautsExploringAnUndergroundCavernO4f79da1b4619447093e1C64b833094b30_1_Image.colorStats = {
    averageColor: Color.fromHex('#204040'),
    lightestColor: Color.fromHex('#77eeff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#eeddbb'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#bb3300'), Color.fromHex('#00eeee')],
    minmaxGreen: [Color.fromHex('#119977'), Color.fromHex('#110011')],
    minmaxBlue: [Color.fromHex('#006688'), Color.fromHex('#eeddbb')],
    mostFrequentColor: Color.fromHex('#110000'),
    mostSaturatedColor: Color.fromHex('#110000'),
    mostGroupedColor: Color.fromHex('#112222'),
    bottom: {
        averageColor: Color.fromHex('#2f3b38'),
        lightestColor: Color.fromHex('#77ffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#99ffee'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#cc4422'), Color.fromHex('#77ffff')],
        minmaxGreen: [Color.fromHex('#229977'), Color.fromHex('#110011')],
        minmaxBlue: [Color.fromHex('#224466'), Color.fromHex('#99ffee')],
        mostFrequentColor: Color.fromHex('#110000'),
