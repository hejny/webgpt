...
import source from './Pavol_Hejn_a_wallpaper_with_a_repeating_pattern_of_abstract_sha_765321f9-4446-424f-bb2d-b2fb28beb9f8-0_1.png';
...
AWallpaperWithARepeatingPatternOfAbstractSha765321f94446424fBb2dB2fb28beb9f80_1_Image.colorStats = {
    averageColor: Color.fromHex('#323228'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#ee0000'), Color.fromHex('#66eedd')],
    minmaxGreen: [Color.fromHex('#55aa44'), Color.fromHex('#ee0000')],
    minmaxBlue: [Color.fromHex('#006699'), Color.fromHex('#ffcc11')],
    mostFrequentColor: Color.fromHex('#664433'),
    mostSaturatedColor: Color.fromHex('#002222'),
    mostGroupedColor: Color.fromHex('#001111'),
    bottom: {
        averageColor: Color.fromHex('#30342a'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#ee0000'), Color.fromHex('#66eedd')],
        minmaxGreen: [Color.fromHex('#11aa77'), Color.fromHex('#ee0000')],
        minmaxBlue: [Color.fromHex('#003366'), Color.fromHex('#ffbb11')],
        mostFrequentColor: Color.fromHex('#664433'),
