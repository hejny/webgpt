...
import source from './Pavol_Hejn_a_photograph_of_the_northern_lights_with_the_green_a_85014640-2d2f-4978-bd3e-e678a1f60ce6-0_3.png';
...
APhotographOfTheNorthernLightsWithTheGreenA850146402d2f4978Bd3eE678a1f60ce60_3_Image.colorStats = {
    averageColor: Color.fromHex('#3f4e52'),
    lightestColor: Color.fromHex('#ffddff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#882277'), Color.fromHex('#ccffff')],
    minmaxGreen: [Color.fromHex('#33cc55'), Color.fromHex('#ffaaff')],
    minmaxBlue: [Color.fromHex('#442277'), Color.fromHex('#ffffee')],
    mostFrequentColor: Color.fromHex('#001111'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#000000'),
    bottom: {
        averageColor: Color.fromHex('#153128'),
        lightestColor: Color.fromHex('#aadd88'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#aaee88'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#665566'), Color.fromHex('#33cc66')],
        minmaxGreen: [Color.fromHex('#33cc55'), Color.fromHex('#000022')],
        minmaxBlue: [Color.fromHex('#225588'), Color.fromHex('#aaee88')],
        mostFrequentColor: Color.fromHex('#001111'),
        mostSaturatedColor: Color.fromHex('#000011'),
        mostGroupedColor: Color.fromHex('#000000'),
    },
