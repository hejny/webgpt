...
export function AGroupOfAinautsObservingTheRingsOfSaturnFroFdae20820fae42beBd9d639ddbc532f90_0_Image() {
    return (
        <Image
            ...
            src={a_group_of_ainauts_observing_the_rings_of_saturn_fro_fdae2082_0fae_42be_bd9d_639ddbc532f9_0_0}
            draggable="false"
            placeholder="blur"
...
AGroupOfAinautsObservingTheRingsOfSaturnFroFdae20820fae42beBd9d639ddbc532f90_0_Image.colorStats = {
    ...
    mostFrequentColor: Color.fromHex('#13110d'),
    leastFrequentColor: Color.fromHex('#635d5e'),
