...
AVintageStyleTravelPosterOfADistantPlanetWiEeecd44a53a944ed8f3e89aa7e7919e90_0_Image.colorStats = {
    averageColor: Color.fromHex('#6c5b4d'),
    ...
    minmaxBlue: [Color.fromHex('#446677'), Color.fromHex('#ffeecc')],
    mostFrequentColor: Color.fromHex('#555555'),
    mostSaturatedColor: Color.fromHex('#110000'),
    mostGroupedColor: Color.fromHex('#111111'),
    bottom: {
        averageColor: Color.fromHex('#61493f'),
        lightestColor: Color.fromHex('#dddddd'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#dddddd'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#bb4422'), Color.fromHex('#dddddd')],
        minmaxGreen: [Color.fromHex('#888866'), Color.fromHex('#110011')],
        minmaxBlue: [Color.fromHex('#223344'), Color.fromHex('#ffaa55')],
        mostFrequentColor: Color.fromHex('#555555'),
        mostSaturatedColor: Color.fromHex('#110000'),
