...
AWallpaperWithARepeatingPatternOfCircuitBoar1d5bfa73C6564cd68a611a1479694a3f0_2_Image.colorStats = {
    averageColor: Color.fromHex('#162719'),
    lightestColor: Color.fromHex('#99aa99'),
    darkestColor: Color.fromHex('#001100'),
    minmaxWhite: [Color.fromHex('#aacc88'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#443311'), Color.fromHex('#119955')],
    minmaxGreen: [Color.fromHex('#55bb44'), Color.fromHex('#110011')],
    minmaxBlue: [Color.fromHex('#444455'), Color.fromHex('#aacc88')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#001100'),
    mostGroupedColor: Color.fromHex('#000000'),
    bottom: {
        averageColor: Color.fromHex('#16271a'),
        lightestColor: Color.fromHex('#88bb99'),
        darkestColor: Color.fromHex('#001100'),
        minmaxWhite: [Color.fromHex('#aacc88'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#445522'), Color.fromHex('#119955')],
        minmaxGreen: [Color.fromHex('#55aa44'), Color.fromHex('#000011')],
        minmaxBlue: [Color.fromHex('#445555'), Color.fromHex('#aacc88')],
        mostFrequentColor: Color.fromHex('#000000'),
        mostSaturatedColor: Color.fromHex('#001100'),
        mostGroupedColor: Color.fromHex('#000000'),
    },
