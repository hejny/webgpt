...
AFuturisticCityscapeWhereAinautsAndAiWorkTogF564cd44Bd0745329e69F62048d5b8e40_1_Image.colorStats = {
    averageColor: Color.fromHex('#475055'),
    ...
    bottom: {
        averageColor: Color.fromHex('#2c2f34'),
        lightestColor: Color.fromHex('#eeeeee'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eeffee'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#995544'), Color.fromHex('#eeffee')],
        minmaxGreen: [Color.fromHex('#778866'), Color.fromHex('#eeeeee')],
