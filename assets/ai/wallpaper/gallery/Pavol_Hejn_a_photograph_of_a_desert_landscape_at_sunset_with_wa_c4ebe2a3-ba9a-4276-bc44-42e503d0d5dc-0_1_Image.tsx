...
APhotographOfADesertLandscapeAtSunsetWithWaC4ebe2a3Ba9a4276Bc4442e503d0d5dc0_1_Image.colorStats = {
    averageColor: Color.fromHex('#7d6449'),
    ...
    mostFrequentColor: Color.fromHex('#885522'),
    ...
    bottom: {
        ...
        minmaxRed: [Color.fromHex('#994411'), Color.fromHex('#ffbb77')],
        minmaxGreen: [Color.fromHex('#887744'), Color.fromHex('#220000')],
        minmaxBlue: [Color.fromHex('#332233'), Color.fromHex('#ffbb66')],
        mostFrequentColor: Color.fromHex('#885522'),
        mostSaturatedColor: Color.fromHex('#332200'),
        mostGroupedColor: Color.fromHex('#111111'),
    },
