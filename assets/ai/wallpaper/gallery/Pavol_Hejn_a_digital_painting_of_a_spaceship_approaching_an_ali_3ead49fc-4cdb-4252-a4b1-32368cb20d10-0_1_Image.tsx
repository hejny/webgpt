...
ADigitalPaintingOfASpaceshipApproachingAnAli3ead49fc4cdb4252A4b132368cb20d100_1_Image.colorStats = {
    averageColor: Color.fromHex('#606160'),
    ...
    bottom: {
        averageColor: Color.fromHex('#45392f'),
        lightestColor: Color.fromHex('#ddcccc'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ddcccc'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#994422'), Color.fromHex('#ddcccc')],
        minmaxGreen: [Color.fromHex('#778855'), Color.fromHex('#110000')],
        minmaxBlue: [Color.fromHex('#334466'), Color.fromHex('#ddcccc')],
        mostFrequentColor: Color.fromHex('#221111'),
        mostSaturatedColor: Color.fromHex('#111100'),
