...
APhotographOfAGlacierOnADistantPlanetWithT6c11a9ac584a4ef1Bbe8D2518ca38b760_1_Image.colorStats = {
    averageColor: Color.fromHex('#365464'),
    ...
    bottom: {
        averageColor: Color.fromHex('#3d505b'),
        lightestColor: Color.fromHex('#eeeeff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eeeeff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#554455'), Color.fromHex('#bbeeff')],
        minmaxGreen: [Color.fromHex('#44aaaa'), Color.fromHex('#eeeeff')],
        minmaxBlue: [Color.fromHex('#116699'), Color.fromHex('#eeeeff')],
        mostFrequentColor: Color.fromHex('#111111'),
