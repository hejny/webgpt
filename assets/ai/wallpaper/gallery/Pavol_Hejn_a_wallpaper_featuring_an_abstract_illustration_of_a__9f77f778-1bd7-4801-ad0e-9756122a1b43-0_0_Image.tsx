...
AWallpaperFeaturingAnAbstractIllustrationOfA9f77f7781bd74801Ad0e9756122a1b430_0_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#cc4444'), Color.fromHex('#55ffee')],
    minmaxGreen: [Color.fromHex('#339988'), Color.fromHex('#ff66aa')],
    minmaxBlue: [Color.fromHex('#0044aa'), Color.fromHex('#ffeeaa')],
    mostFrequentColor: Color.fromHex('#112244'),
    mostSaturatedColor: Color.fromHex('#001122'),
    mostGroupedColor: Color.fromHex('#111122'),
    bottom: {
        averageColor: Color.fromHex('#3e243c'),
        lightestColor: Color.fromHex('#ccccee'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffeedd'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#cc4444'), Color.fromHex('#eeeedd')],
        minmaxGreen: [Color.fromHex('#445555'), Color.fromHex('#ff66aa')],
        minmaxBlue: [Color.fromHex('#112266'), Color.fromHex('#ffeeaa')],
        mostFrequentColor: Color.fromHex('#112244'),
        mostSaturatedColor: Color.fromHex('#001122'),
        mostGroupedColor: Color.fromHex('#111122'),
    },
