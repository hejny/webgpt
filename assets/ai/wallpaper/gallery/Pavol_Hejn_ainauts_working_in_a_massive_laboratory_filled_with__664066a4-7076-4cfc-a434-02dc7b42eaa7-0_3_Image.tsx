...
AinautsWorkingInAMassiveLaboratoryFilledWith664066a470764cfcA43402dc7b42eaa70_3_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#334444'), Color.fromHex('#00ccee')],
    minmaxGreen: [Color.fromHex('#008888'), Color.fromHex('#ffffff')],
    ...
    bottom: {
        averageColor: Color.fromHex('#133746'),
        lightestColor: Color.fromHex('#eeffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eeffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#111111'), Color.fromHex('#00ccee')],
        minmaxGreen: [Color.fromHex('#116666'), Color.fromHex('#eeffff')],
