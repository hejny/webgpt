...
AWallpaperWithASimpleGraphicOfADigitalDashbe3e028cEf5f4a5cA2bbA3059b50d0f003_3_Image.colorStats = {
    averageColor: Color.fromHex('#0e1d29'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#884466'), Color.fromHex('#55ffff')],
    ...
    bottom: {
        averageColor: Color.fromHex('#112331'),
        lightestColor: Color.fromHex('#ccffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ccffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#994477'), Color.fromHex('#55eeff')],
        minmaxGreen: [Color.fromHex('#119988'), Color.fromHex('#ee99cc')],
        minmaxBlue: [Color.fromHex('#004477'), Color.fromHex('#ccffff')],
        mostFrequentColor: Color.fromHex('#000000'),
        mostSaturatedColor: Color.fromHex('#000011'),
        mostGroupedColor: Color.fromHex('#000000'),
    },
