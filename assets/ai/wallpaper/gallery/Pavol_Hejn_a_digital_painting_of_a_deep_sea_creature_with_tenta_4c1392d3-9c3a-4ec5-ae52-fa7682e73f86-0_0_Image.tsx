...
ADigitalPaintingOfADeepSeaCreatureWithTenta4c1392d39c3a4ec5Ae52Fa7682e73f860_0_Image.colorStats = {
    averageColor: Color.fromHex('#11161f'),
    lightestColor: Color.fromHex('#eeeeee'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffdd'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#aa5566'), Color.fromHex('#88ffee')],
    minmaxGreen: [Color.fromHex('#22aa77'), Color.fromHex('#ffffdd')],
    minmaxBlue: [Color.fromHex('#4455bb'), Color.fromHex('#ffffdd')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#000000'),
    bottom: {
        averageColor: Color.fromHex('#090d16'),
        lightestColor: Color.fromHex('#cc99cc'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#bbbbbb'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#bb5577'), Color.fromHex('#66bbaa')],
        minmaxGreen: [Color.fromHex('#337766'), Color.fromHex('#220000')],
        minmaxBlue: [Color.fromHex('#224499'), Color.fromHex('#bbbbbb')],
        mostFrequentColor: Color.fromHex('#000000'),
        mostSaturatedColor: Color.fromHex('#000011'),
        mostGroupedColor: Color.fromHex('#000000'),
    },
