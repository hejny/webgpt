...
APixelArtDepictionOfASpacecraftWithBlockySh914c341bC58243fa908cC2b67d4a0e550_2_Image.colorStats = {
    ...
    minmaxGreen: [Color.fromHex('#339988'), Color.fromHex('#ee2222')],
    minmaxBlue: [Color.fromHex('#336688'), Color.fromHex('#ffffcc')],
    ...
    bottom: {
        ...
        minmaxWhite: [Color.fromHex('#eeeecc'), Color.fromHex('#001111')],
        minmaxRed: [Color.fromHex('#ee2222'), Color.fromHex('#eeeecc')],
        minmaxGreen: [Color.fromHex('#44aa99'), Color.fromHex('#ee2222')],
        minmaxBlue: [Color.fromHex('#224466'), Color.fromHex('#ffdd77')],
        mostFrequentColor: Color.fromHex('#112233'),
