...
import content from './Pavol_Hejn_a_desert_landscape_with_a_cactus_in_the_foreground_26ff23d7-b92e-4874-8653-6d42fb8e622a-0_1.content.md';
...
export function ADesertLandscapeWithACactusInTheForeground26ff23d7B92e487486536d42fb8e622a0_1_Image(
    ...
    return (
        <Image
            ...
            src="https://cdn.midjourney.com/26ff23d7-b92e-4874-8653-6d42fb8e622a/0_1.png"
            draggable="false"
            placeholder="blur"
...
ADesertLandscapeWithACactusInTheForeground26ff23d7B92e487486536d42fb8e622a0_1_Image.src = new URL(
    'https://cdn.midjourney.com/26ff23d7-b92e-4874-8653-6d42fb8e622a/0_1.png',
);
...
ADesertLandscapeWithACactusInTheForeground26ff23d7B92e487486536d42fb8e622a0_1_Image.content = content;
