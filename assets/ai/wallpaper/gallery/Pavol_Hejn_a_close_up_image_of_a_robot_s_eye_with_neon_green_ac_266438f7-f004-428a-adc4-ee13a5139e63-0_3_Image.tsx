...
ACloseUpImageOfARobotSEyeWithNeonGreenAc266438f7F004428aAdc4Ee13a5139e630_3_Image.colorStats = {
    averageColor: Color.fromHex('#132820'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#bb2200'), Color.fromHex('#11ff88')],
    minmaxGreen: [Color.fromHex('#00cc33'), Color.fromHex('#ffeeff')],
    ...
    bottom: {
        averageColor: Color.fromHex('#091a13'),
        lightestColor: Color.fromHex('#eeffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eeffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#444444'), Color.fromHex('#00ff77')],
        minmaxGreen: [Color.fromHex('#11dd33'), Color.fromHex('#eeffff')],
