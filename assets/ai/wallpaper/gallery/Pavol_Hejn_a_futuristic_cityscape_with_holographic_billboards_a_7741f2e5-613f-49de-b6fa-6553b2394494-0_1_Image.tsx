...
AFuturisticCityscapeWithHolographicBillboardsA7741f2e5613f49deB6fa6553b23944940_1_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#dd2233'), Color.fromHex('#33ccff')],
    minmaxGreen: [Color.fromHex('#338899'), Color.fromHex('#cc22aa')],
    minmaxBlue: [Color.fromHex('#2233aa'), Color.fromHex('#ffeeee')],
    mostFrequentColor: Color.fromHex('#111133'),
    mostSaturatedColor: Color.fromHex('#001144'),
    mostGroupedColor: Color.fromHex('#112244'),
    bottom: {
        averageColor: Color.fromHex('#603e77'),
        lightestColor: Color.fromHex('#ffccee'),
        darkestColor: Color.fromHex('#111133'),
        minmaxWhite: [Color.fromHex('#ffeeee'), Color.fromHex('#110033')],
        minmaxRed: [Color.fromHex('#ee2233'), Color.fromHex('#99eeee')],
        minmaxGreen: [Color.fromHex('#44aaaa'), Color.fromHex('#ff66dd')],
        minmaxBlue: [Color.fromHex('#3355bb'), Color.fromHex('#ffeeee')],
        mostFrequentColor: Color.fromHex('#111133'),
        mostSaturatedColor: Color.fromHex('#001144'),
