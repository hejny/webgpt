...
import source from './Pavol_Hejn_a_wallpaper_with_a_simple_graphic_of_an_abstract_cir_8d748831-9591-44f9-b973-c33da51761b8-0_2.png';
...
AWallpaperWithASimpleGraphicOfAnAbstractCir8d748831959144f9B973C33da51761b80_2_Image.colorStats = {
    averageColor: Color.fromHex('#033f51'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#333333'), Color.fromHex('#00ffff')],
    minmaxGreen: [Color.fromHex('#00ff66'), Color.fromHex('#0033ee')],
    minmaxBlue: [Color.fromHex('#0033ee'), Color.fromHex('#ffffff')],
    mostFrequentColor: Color.fromHex('#004444'),
    mostSaturatedColor: Color.fromHex('#0066ee'),
    mostGroupedColor: Color.fromHex('#002222'),
    bottom: {
        averageColor: Color.fromHex('#044a54'),
        lightestColor: Color.fromHex('#ffeeff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#eeffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#333333'), Color.fromHex('#00ffff')],
        minmaxGreen: [Color.fromHex('#00ff66'), Color.fromHex('#ffeeff')],
        minmaxBlue: [Color.fromHex('#0033dd'), Color.fromHex('#eeffee')],
        mostFrequentColor: Color.fromHex('#004444'),
