...
AinautsExploringAVastNetworkOfTunnelsBeneath23dd2e38A5294e63B9d619877ef9d20e0_1_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#dd4422'), Color.fromHex('#66eedd')],
    minmaxGreen: [Color.fromHex('#77bb66'), Color.fromHex('#ee77aa')],
    ...
    bottom: {
        ...
        minmaxGreen: [Color.fromHex('#77bb66'), Color.fromHex('#ee77aa')],
        minmaxBlue: [Color.fromHex('#444477'), Color.fromHex('#ffeeaa')],
        mostFrequentColor: Color.fromHex('#002233'),
