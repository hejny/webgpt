...
AWallpaperFeaturingAnAbstractIllustrationOfAn3776e2686f514049Ba720277e62ebba50_1_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#dd2266'), Color.fromHex('#00ffff')],
    minmaxGreen: [Color.fromHex('#009999'), Color.fromHex('#cc22ff')],
    minmaxBlue: [Color.fromHex('#2222aa'), Color.fromHex('#ddffee')],
    mostFrequentColor: Color.fromHex('#553377'),
    mostSaturatedColor: Color.fromHex('#0099aa'),
    mostGroupedColor: Color.fromHex('#002244'),
    bottom: {
        averageColor: Color.fromHex('#34346a'),
        lightestColor: Color.fromHex('#ddffff'),
        darkestColor: Color.fromHex('#000011'),
        minmaxWhite: [Color.fromHex('#ddffff'), Color.fromHex('#000011')],
        minmaxRed: [Color.fromHex('#ff3355'), Color.fromHex('#11ffff')],
        minmaxGreen: [Color.fromHex('#11bbaa'), Color.fromHex('#cc22ee')],
        minmaxBlue: [Color.fromHex('#112288'), Color.fromHex('#ddffee')],
        mostFrequentColor: Color.fromHex('#553377'),
