...
ADigitalIllustrationOfASpaceshipTravelingThroA64253377d464a4fAe01A169331d952d0_3_Image.colorStats = {
    averageColor: Color.fromHex('#4d465b'),
    ...
    minmaxGreen: [Color.fromHex('#668877'), Color.fromHex('#ffccdd')],
    ...
    bottom: {
        averageColor: Color.fromHex('#473c55'),
        lightestColor: Color.fromHex('#ddffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ddffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#bb4422'), Color.fromHex('#ddffff')],
        minmaxGreen: [Color.fromHex('#337799'), Color.fromHex('#eeddee')],
