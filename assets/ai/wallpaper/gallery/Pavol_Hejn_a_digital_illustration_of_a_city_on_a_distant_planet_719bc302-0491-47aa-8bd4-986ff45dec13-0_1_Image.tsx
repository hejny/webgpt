...
import content from './Pavol_Hejn_a_digital_illustration_of_a_city_on_a_distant_planet_719bc302-0491-47aa-8bd4-986ff45dec13-0_1.content.md';
...
export function ADigitalIllustrationOfACityOnADistantPlanet719bc302049147aa8bd4986ff45dec130_1_Image(
    ...
    return (
        <Image
            ...
            src="https://cdn.midjourney.com/719bc302-0491-47aa-8bd4-986ff45dec13/0_1.png"
            draggable="false"
            placeholder="blur"
...
ADigitalIllustrationOfACityOnADistantPlanet719bc302049147aa8bd4986ff45dec130_1_Image.src = new URL(
    'https://cdn.midjourney.com/719bc302-0491-47aa-8bd4-986ff45dec13/0_1.png',
);
...
ADigitalIllustrationOfACityOnADistantPlanet719bc302049147aa8bd4986ff45dec130_1_Image.content = content;
