...
ThisIsALargeFieldInTheStyleOfRichlyColoredFd48da16A3c24262Bf66E0ded7fc9f6b0_2_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#882233'), Color.fromHex('#eeddbb')],
    minmaxGreen: [Color.fromHex('#668866'), Color.fromHex('#440000')],
    minmaxBlue: [Color.fromHex('#556677'), Color.fromHex('#eeddbb')],
    mostFrequentColor: Color.fromHex('#111111'),
    mostSaturatedColor: Color.fromHex('#110000'),
    mostGroupedColor: Color.fromHex('#eebbaa'),
    bottom: {
        averageColor: Color.fromHex('#392f23'),
        lightestColor: Color.fromHex('#ddcccc'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ddcccc'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#882233'), Color.fromHex('#ddcccc')],
        minmaxGreen: [Color.fromHex('#668866'), Color.fromHex('#440000')],
        minmaxBlue: [Color.fromHex('#556677'), Color.fromHex('#ddccbb')],
        mostFrequentColor: Color.fromHex('#111111'),
