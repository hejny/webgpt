...
ASurrealistInspiredWallpaperWithFloatingObjectde16b7368894692Aa110fce4396fc3a02_2_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#774422'), Color.fromHex('#eeddbb')],
    minmaxGreen: [Color.fromHex('#888855'), Color.fromHex('#110000')],
    ...
    bottom: {
        averageColor: Color.fromHex('#7b6e5a'),
        lightestColor: Color.fromHex('#eeddbb'),
        darkestColor: Color.fromHex('#111100'),
        minmaxWhite: [Color.fromHex('#eeddbb'), Color.fromHex('#110000')],
        minmaxRed: [Color.fromHex('#664422'), Color.fromHex('#eeddbb')],
        minmaxGreen: [Color.fromHex('#777744'), Color.fromHex('#220000')],
