...
import source from './Pavol_Hejn_a_wallpaper_featuring_a_collage_of_futuristic_techno_a61d8392-6cb0-4241-aa9a-96f23c0bbb65-0_0.png';
...
AWallpaperFeaturingACollageOfFuturisticTechnoA61d83926cb04241Aa9a96f23c0bbb650_0_Image.colorStats = {
    averageColor: Color.fromHex('#12242f'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#bb1122'), Color.fromHex('#00ffff')],
    minmaxGreen: [Color.fromHex('#77aa22'), Color.fromHex('#cc33dd')],
    minmaxBlue: [Color.fromHex('#4444aa'), Color.fromHex('#ffff66')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#000011'),
    mostGroupedColor: Color.fromHex('#002233'),
    bottom: {
        averageColor: Color.fromHex('#11212d'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#bb1122'), Color.fromHex('#11ffff')],
        minmaxGreen: [Color.fromHex('#229977'), Color.fromHex('#cc33dd')],
