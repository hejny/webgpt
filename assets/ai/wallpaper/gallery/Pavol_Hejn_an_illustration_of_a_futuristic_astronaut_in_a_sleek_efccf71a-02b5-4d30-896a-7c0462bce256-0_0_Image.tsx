...
export function AnIllustrationOfAFuturisticAstronautInASleekEfccf71a02b54d30896a7c0462bce2560_0_Image() {
    return (
        <Image
            ...
            src={an_illustration_of_a_futuristic_astronaut_in_a_sleek_efccf71a_02b5_4d30_896a_7c0462bce256_0_0}
            draggable="false"
            placeholder="blur"
...
AnIllustrationOfAFuturisticAstronautInASleekEfccf71a02b54d30896a7c0462bce2560_0_Image.colorStats = {
    ...
    mostFrequentColor: Color.fromHex('#fdecdf'),
    leastFrequentColor: Color.fromHex('#2f425a'),
