...
export function AnIllustrationOfARoboticExplorerWithMetallic8b9d2ad412244f63844f96fe15181e130_3_Image() {
    return (
        <Image
            ...
            src={an_illustration_of_a_robotic_explorer_with_metallic_8b9d2ad4_1224_4f63_844f_96fe15181e13_0_3}
            draggable="false"
            placeholder="blur"
...
AnIllustrationOfARoboticExplorerWithMetallic8b9d2ad412244f63844f96fe15181e130_3_Image.colorStats = {
    ...
    mostFrequentColor: Color.fromHex('#e4d7b5'),
    leastFrequentColor: Color.fromHex('#e2d5ab'),
