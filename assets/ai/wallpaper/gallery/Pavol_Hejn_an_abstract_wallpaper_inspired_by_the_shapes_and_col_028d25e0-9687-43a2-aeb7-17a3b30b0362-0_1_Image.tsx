...
AnAbstractWallpaperInspiredByTheShapesAndCol028d25e0968743a2Aeb717a3b30b03620_1_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#bb2222'), Color.fromHex('#0099aa')],
    minmaxGreen: [Color.fromHex('#119966'), Color.fromHex('#ee4488')],
    minmaxBlue: [Color.fromHex('#114466'), Color.fromHex('#eecc66')],
    mostFrequentColor: Color.fromHex('#111111'),
    mostSaturatedColor: Color.fromHex('#001111'),
    mostGroupedColor: Color.fromHex('#111111'),
    bottom: {
        averageColor: Color.fromHex('#162023'),
        lightestColor: Color.fromHex('#ee9966'),
        darkestColor: Color.fromHex('#111100'),
        minmaxWhite: [Color.fromHex('#ee9966'), Color.fromHex('#000011')],
        minmaxRed: [Color.fromHex('#bb2222'), Color.fromHex('#119977')],
        minmaxGreen: [Color.fromHex('#229966'), Color.fromHex('#bb1166')],
        minmaxBlue: [Color.fromHex('#223355'), Color.fromHex('#dd9944')],
        mostFrequentColor: Color.fromHex('#111111'),
        mostSaturatedColor: Color.fromHex('#001111'),
        mostGroupedColor: Color.fromHex('#111111'),
    },
