...
APhotographOfTheNorthernLightsWithTheGreenA5a41273d2d954ce3B35b147b130703eb0_2_Image.colorStats = {
    ...
    lightestColor: Color.fromHex('#99aacc'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#cceebb'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#774455'), Color.fromHex('#bbeebb')],
    minmaxGreen: [Color.fromHex('#44aa33'), Color.fromHex('#330022')],
    minmaxBlue: [Color.fromHex('#552255'), Color.fromHex('#ccee99')],
    mostFrequentColor: Color.fromHex('#112222'),
    mostSaturatedColor: Color.fromHex('#001111'),
    mostGroupedColor: Color.fromHex('#222233'),
    bottom: {
        averageColor: Color.fromHex('#1c2f1e'),
        lightestColor: Color.fromHex('#ccddcc'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ccddcc'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#444433'), Color.fromHex('#ccddcc')],
        minmaxGreen: [Color.fromHex('#55aa22'), Color.fromHex('#000011')],
        minmaxBlue: [Color.fromHex('#223344'), Color.fromHex('#aadd55')],
        mostFrequentColor: Color.fromHex('#112222'),
