...
AGroupOfAinautsStandingOnTheSurfaceOfARedE04ecc2439004694B550F31df323741e0_1_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#884422'), Color.fromHex('#eeddaa')],
    minmaxGreen: [Color.fromHex('#776644'), Color.fromHex('#110000')],
    minmaxBlue: [Color.fromHex('#443333'), Color.fromHex('#eeddaa')],
    mostFrequentColor: Color.fromHex('#663322'),
    mostSaturatedColor: Color.fromHex('#221100'),
    mostGroupedColor: Color.fromHex('#774422'),
    bottom: {
        averageColor: Color.fromHex('#673a22'),
        lightestColor: Color.fromHex('#bb8855'),
        darkestColor: Color.fromHex('#331100'),
        minmaxWhite: [Color.fromHex('#bb8855'), Color.fromHex('#111111')],
        minmaxRed: [Color.fromHex('#884422'), Color.fromHex('#111111')],
        minmaxGreen: [Color.fromHex('#aa8855'), Color.fromHex('#331111')],
        minmaxBlue: [Color.fromHex('#443333'), Color.fromHex('#bb8855')],
        mostFrequentColor: Color.fromHex('#663322'),
