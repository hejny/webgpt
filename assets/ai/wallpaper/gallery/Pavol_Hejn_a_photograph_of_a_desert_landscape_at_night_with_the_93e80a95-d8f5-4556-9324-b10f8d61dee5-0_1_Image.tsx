...
APhotographOfADesertLandscapeAtNightWithThe93e80a95D8f545569324B10f8d61dee50_1_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#884411'), Color.fromHex('#88ffff')],
    minmaxGreen: [Color.fromHex('#777744'), Color.fromHex('#ffffff')],
    minmaxBlue: [Color.fromHex('#1144cc'), Color.fromHex('#ffffee')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#001111'),
    mostGroupedColor: Color.fromHex('#111111'),
    bottom: {
        averageColor: Color.fromHex('#251b13'),
        lightestColor: Color.fromHex('#776644'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#776644'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#884422'), Color.fromHex('#001111')],
        minmaxGreen: [Color.fromHex('#776644'), Color.fromHex('#220000')],
        minmaxBlue: [Color.fromHex('#664444'), Color.fromHex('#553300')],
        mostFrequentColor: Color.fromHex('#000000'),
