...
ATeamOfAinautsAndTheirAiCompanionsExploring77f2caadFd45498fB3bcB9785bd397bd0_0_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#552233'), Color.fromHex('#99ffff')],
    minmaxGreen: [Color.fromHex('#228888'), Color.fromHex('#ffffff')],
    minmaxBlue: [Color.fromHex('#117799'), Color.fromHex('#ffffee')],
    mostFrequentColor: Color.fromHex('#111111'),
    mostSaturatedColor: Color.fromHex('#110011'),
    mostGroupedColor: Color.fromHex('#111111'),
    bottom: {
        averageColor: Color.fromHex('#252c2f'),
        lightestColor: Color.fromHex('#ffffff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#554433'), Color.fromHex('#aaffee')],
        minmaxGreen: [Color.fromHex('#228888'), Color.fromHex('#ffffff')],
        minmaxBlue: [Color.fromHex('#227799'), Color.fromHex('#ffffee')],
        mostFrequentColor: Color.fromHex('#111111'),
        mostSaturatedColor: Color.fromHex('#110011'),
        mostGroupedColor: Color.fromHex('#111111'),
    },
