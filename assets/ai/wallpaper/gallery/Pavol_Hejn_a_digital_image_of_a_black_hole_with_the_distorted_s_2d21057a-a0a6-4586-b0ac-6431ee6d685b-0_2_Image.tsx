...
ADigitalImageOfABlackHoleWithTheDistortedSd21057aA0a64586B0ac6431ee6d685b02_2_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#dd1100'), Color.fromHex('#44ffff')],
    minmaxGreen: [Color.fromHex('#22aa99'), Color.fromHex('#cc0022')],
    minmaxBlue: [Color.fromHex('#444499'), Color.fromHex('#ffff88')],
    mostFrequentColor: Color.fromHex('#000000'),
    mostSaturatedColor: Color.fromHex('#110011'),
    mostGroupedColor: Color.fromHex('#000000'),
    bottom: {
        averageColor: Color.fromHex('#0a090f'),
        lightestColor: Color.fromHex('#66eedd'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#ffeeaa'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#dd1100'), Color.fromHex('#66eedd')],
        minmaxGreen: [Color.fromHex('#55aa88'), Color.fromHex('#dd1100')],
        minmaxBlue: [Color.fromHex('#115599'), Color.fromHex('#ffeeaa')],
        mostFrequentColor: Color.fromHex('#000000'),
