...
ASurrealInterpretationOfADesertLandscapeF047f1c7B6f34eae88f82fb6ec5c16070_3_Image.colorStats = {
    ...
    minmaxRed: [Color.fromHex('#996655'), Color.fromHex('#ddddcc')],
    minmaxGreen: [Color.fromHex('#778866'), Color.fromHex('#eeddcc')],
    ...
    bottom: {
        averageColor: Color.fromHex('#887260'),
        lightestColor: Color.fromHex('#eeccaa'),
        darkestColor: Color.fromHex('#111111'),
        minmaxWhite: [Color.fromHex('#eeccaa'), Color.fromHex('#111111')],
        minmaxRed: [Color.fromHex('#996655'), Color.fromHex('#ddccaa')],
        minmaxGreen: [Color.fromHex('#777755'), Color.fromHex('#221122')],
        minmaxBlue: [Color.fromHex('#333344'), Color.fromHex('#eeccaa')],
        mostFrequentColor: Color.fromHex('#554444'),
        mostSaturatedColor: Color.fromHex('#332211'),
