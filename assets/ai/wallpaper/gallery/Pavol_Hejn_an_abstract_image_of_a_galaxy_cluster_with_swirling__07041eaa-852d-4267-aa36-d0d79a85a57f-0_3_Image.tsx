...
AnAbstractImageOfAGalaxyClusterWithSwirling07041eaa852d4267Aa36D0d79a85a57f0_3_Image.colorStats = {
    averageColor: Color.fromHex('#554548'),
    lightestColor: Color.fromHex('#eedddd'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#eedddd'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#bb3311'), Color.fromHex('#55bbcc')],
    minmaxGreen: [Color.fromHex('#337766'), Color.fromHex('#660022')],
    minmaxBlue: [Color.fromHex('#224477'), Color.fromHex('#eecc88')],
    mostFrequentColor: Color.fromHex('#002233'),
    mostSaturatedColor: Color.fromHex('#110000'),
    mostGroupedColor: Color.fromHex('#001122'),
    bottom: {
        averageColor: Color.fromHex('#504548'),
        lightestColor: Color.fromHex('#dddddd'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#dddddd'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#bb3311'), Color.fromHex('#dddddd')],
        minmaxGreen: [Color.fromHex('#337766'), Color.fromHex('#550011')],
        minmaxBlue: [Color.fromHex('#335588'), Color.fromHex('#eecc99')],
        mostFrequentColor: Color.fromHex('#002233'),
