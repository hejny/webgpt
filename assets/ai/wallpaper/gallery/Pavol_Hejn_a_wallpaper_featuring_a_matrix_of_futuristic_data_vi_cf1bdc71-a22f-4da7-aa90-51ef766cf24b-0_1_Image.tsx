...
AWallpaperFeaturingAMatrixOfFuturisticDataViCf1bdc71A22f4da7Aa9051ef766cf24b0_1_Image.colorStats = {
    averageColor: Color.fromHex('#182d38'),
    lightestColor: Color.fromHex('#ffffff'),
    darkestColor: Color.fromHex('#000000'),
    minmaxWhite: [Color.fromHex('#ffffff'), Color.fromHex('#000000')],
    minmaxRed: [Color.fromHex('#994444'), Color.fromHex('#bbffff')],
    ...
    bottom: {
        averageColor: Color.fromHex('#12242e'),
        lightestColor: Color.fromHex('#cceeff'),
        darkestColor: Color.fromHex('#000000'),
        minmaxWhite: [Color.fromHex('#cceeff'), Color.fromHex('#000000')],
        minmaxRed: [Color.fromHex('#664444'), Color.fromHex('#bbeeff')],
        minmaxGreen: [Color.fromHex('#337766'), Color.fromHex('#cceeff')],
        minmaxBlue: [Color.fromHex('#225577'), Color.fromHex('#cceeee')],
        mostFrequentColor: Color.fromHex('#001111'),
