...
AGroupOfAinautsStandingOnTheSurfaceOfARedE04ecc2439004694B550F31df323741e0_0_Image.colorStats = {
    averageColor: Color.fromHex('#a17d67'),
    ...
    minmaxBlue: [Color.fromHex('#332233'), Color.fromHex('#ffffdd')],
    mostFrequentColor: Color.fromHex('#441111'),
    mostSaturatedColor: Color.fromHex('#111100'),
    mostGroupedColor: Color.fromHex('#ffeedd'),
    bottom: {
        averageColor: Color.fromHex('#7d4b35'),
        lightestColor: Color.fromHex('#ffddbb'),
        darkestColor: Color.fromHex('#111100'),
        minmaxWhite: [Color.fromHex('#ffeebb'), Color.fromHex('#110000')],
        minmaxRed: [Color.fromHex('#aa4422'), Color.fromHex('#ffeebb')],
        minmaxGreen: [Color.fromHex('#aa8855'), Color.fromHex('#220011')],
        minmaxBlue: [Color.fromHex('#332233'), Color.fromHex('#ffeebb')],
        mostFrequentColor: Color.fromHex('#441111'),
        mostSaturatedColor: Color.fromHex('#111100'),
